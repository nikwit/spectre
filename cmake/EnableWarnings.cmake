...
# - GCC versions below 13 have many false positives for `stringop-overflow`,
#   `array-bounds`, and `restrict`, specifically in libstdc++-12 <string> with
#   C++20, leading to warnings from `__builtin_memcpy`.
# - GCC version 12 has false-positive `use-after-free` warnings from Blaze's
#   DynamicMatrix constructor that gets inlined in many places. Rather than
#   silencing the warning at every call site or forcing no-inline, we silence
#   it here.
