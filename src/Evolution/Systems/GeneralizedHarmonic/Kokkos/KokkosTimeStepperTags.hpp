...
struct DeviceConstraintGamma1 : db::SimpleTag {
  using type = typename ::Tags::MirrorView<gh::Tags::ConstraintGamma1>::type;
};

struct DeviceConstraintGamma2 : db::SimpleTag {
  using type = typename ::Tags::MirrorView<gh::Tags::ConstraintGamma2>::type;
};
