...
template <size_t Dim>
class ConstraintPreservingBaylissTurkel final : public BoundaryCondition<Dim> {
 public:
  ...
  ConstraintPreservingBaylissTurkel() = default;
  /// \cond
  ConstraintPreservingBaylissTurkel(
      ConstraintPreservingBaylissTurkel&&) noexcept = default;
  ConstraintPreservingBaylissTurkel& operator=(
      ConstraintPreservingBaylissTurkel&&) noexcept = default;
  ConstraintPreservingBaylissTurkel(const ConstraintPreservingBaylissTurkel&) =
      default;
  ConstraintPreservingBaylissTurkel& operator=(
      const ConstraintPreservingBaylissTurkel&) = default;
  /// \endcond
  ~ConstraintPreservingBaylissTurkel() override = default;

  explicit ConstraintPreservingBaylissTurkel(CkMigrateMessage* msg) noexcept;
  ...
  using dg_interior_deriv_vars_tags =
      tmpl::list<::Tags::deriv<Pi, tmpl::size_t<Dim>, Frame::Inertial>,
                 ::Tags::deriv<Psi, tmpl::size_t<Dim>, Frame::Inertial>,
