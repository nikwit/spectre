...
void puncture_field_2_part_10(const std::array<double, order2_n_doubles>& d,
  ...
  sc_31 +=
      Dx * ((-M) * ((-M) * (dv_2551 - 16.0) + dv_2877 + dv_3239) + dv_2873 +
            yp * ((-d[36]) * (dv_3238 - 127.0) + d[2030] + 884.0 * dv_3068 +
                  33.0 * dv_794));
  ...
  sc_13 =
      (-d[122]) *
          (d[1048] * ((-xpdot) * dv_678 + 36.0 * dv_1903 + dv_3237) + dv_2865) +
  ...
  sc_6 += (-d[1792]) * dv_3061 + (M * d[1307]) * dv_1200 +
          (d[1033] * d[1053]) * dv_106 + (d[1088] * d[6]) * dv_46 +
          (d[255] * d[6]) * dv_615 + (-M * d[1033]) * dv_297 +
  ...
  sc_6 += M * dv_2143 + M * dv_2145 + M * dv_2146 + d[1033] * dv_3058 +
          d[1053] * dv_567 + d[1053] * dv_608 + d[1242] * dv_2148 +
          d[1307] * dv_3059 + d[1406] * dv_48 + d[1474] * dv_2147;
  ...
  sc_6 += (-d[1447]) * dv_0 * dv_833 - dv_2443 * dv_2950 +
          xp * ((-M) * dv_2160 +
                (-d[1217]) *
                    (d[1248] * dv_732 + dv_3062 - dv_548 + dv_555 * xpdot) +
                (M * xpddot) * dv_2154);
  ...
  sc_24 += d[77] * ((d[1] * d[147]) + d[1070] * dv_1115 +
                    d[648] * (dv_2739 + dv_3081) - dv_3075 - dv_3080 +
                    ypdot * ((-M) * dv_3084 + (-d[1668] * d[6]) + dv_3082));
  sc_16 = (-d[1807]) * sc_24;
  ...
  sc_29 = (-d[1819] - d[567]) * dv_3067 +
          (-xpdot) * ((-d[1808] - d[1820] - 36.0) * dv_1817 +
                      d[77] * (M * dv_3092 + d[1667] - dv_3088) + dv_3069) +
  ...
  sc_18 +=
      d[77] * ((-d[7]) * dv_3077 + d[1579] + d[648] * dv_2344 + dv_3075 +
               dv_3076 + ypdot * ((-d[1803]) + M * dv_3078 + d[1029] * dv_0));
  sc_29 = d[1804] * sc_18;
  ...
  sc_12 +=
      (-d[77]) *
          ((-d[1306]) * Dy + (-ypdot) * ((-M) * dv_3085 + d[1811] - dv_3082) +
           d[1810] + d[648] * (dv_3081 + dv_558 * xpddot) + dv_3076 + dv_3080) +
      (27.0 * d[20] * rpdot) * dv_1828;
  sc_18 = d[1812] * sc_12;
  ...
  sc_31 = (-d[252]) * ((d[1188] + d[152] + 18.0) * dv_2170 + dv_3087) +
          ...
          (3.0 * rpdot * (d[1682] - d[1813] * d[259] + d[563])) * Dx;
  DataVector& dv_1821 = temps.at(1607);
  DataVector& dv_3091 = temps.at(2584);
  sc_31 += xpdot * ((-d[1805] - d[1814] - 30.0) * dv_1821 +
  ...
  sc_17 =
      (d[1] * d[1797]) * (d[1330] * dv_1 + d[142] * dv_1762 + d[36] * dv_3063 +
                          xpdot * ((d[1035] + d[298] - 6.0) * dv_833 +
                                   yp * (d[1054] + dv_2331 + dv_3064))) +
  ...
  sc_17 +=
      d[1800] *
          ((-d[1798] + 5.0 * d[36]) * dv_3065 + (d[1449] * d[221]) +
           ...
           xpdot * (d[72] * dv_794 + d[77] * (d[1509] + dv_3064 + dv_3072) +
                    dv_3069)) +
      sc_29;
  sc_17 += sc_12 + sc_18;
  ...
  sc_29 += d[1250] * ((d[1809] - 90.0) * dv_2421 + (120.0 * rpdot) * dv_850 +
  ...
  sc_29 +=
      d[273] * ((d[1884] - 517.0) * dv_794 +
                d[1236] * (dv_2431 + dv_2766 + 6.0) + d[1883] + dv_3122) +
      d[287] * ((-d[1880] - 27.0) * dv_69 + (3.0 * M) * (dv_1502 + dv_3101) +
                (-d[1671]) - 18.0 * dv_2246);
  sc_18 = (-d[1841]) * sc_29;
  ...
  sc_31 =
      ...
      (-d[273]) * ((-540.0 * rpdot - 1037.0) * dv_794 +
                   d[1236] * (dv_2431 + dv_3106) + d[1888] + dv_793 * rpdot) +
  ...
  sc_32 +=
      (-M) * ((d[1242] + d[1447] - 36.0 * ypdot) * dv_3117 +
              (-d[1682]) * ((53.0 * ypdot) * Dx - dv_2437 - dv_2495) +
              (-d[50]) * (53.0 * dv_1803 + dv_3130 * xpddot) + 84.0 * dv_2371);
  ...
  sc_34 *= (-d[1897]) * dv_3132 + (-d[51]) * ((127.0 * d[36]) + Dy * d[1884]) +
           (M * d[20]) * ((-d[42]) * (dv_2477 + dv_3109) + (252.0 * d[255]) +
                          d[1891] * dv_1) +
           (3.0 * d[48] * yp) * ((-d[7]) * dv_2997 + d[37] + dv_3133);
  ...
  sc_33 += M * ((-d[1299]) * (dv_2376 + dv_3131 - 45.0 * dv_751) +
  ...
  sc_34 += M * ((d[1230] + d[1650]) * dv_3117 + d[138] * dv_1112 +
                d[1628] * ((-xpddot) * dv_3118 + dv_2396 + 109.0 * dv_751) +
  ...
  sc_12 =
      ...
      d[1466] *
          ((-M * (d[1033] * d[1221] + d[1420] + d[1867]) + d[1311] * d[1865]) *
               dv_1564 +
           (d[1] * d[35] * d[495]) +
           d[259] * ((-d[504]) * (dv_1553 + dv_1570) +
                     yp * ((-42.0 * d[7]) + 53.0 * dv_1502 + dv_2341))) +
      sc_16 + sc_18 + sc_24 + sc_29 + sc_31;
  DataVector& dv_2818 = temps.at(2370);
  sc_12 += d[1864] * ((-d[261] * xpdot) + dv_2818) + sc_32 + sc_33;
  ...
  sc_31 = (-d[1250]) * ((d[42] * (d[1068] + d[1785] + 16.0)) * dv_231 +
                        d[1849] * dv_3108 +
                        d[348] * ((d[1851] * ypdot) * Dx - dv_2497 - dv_3104)) +
          dv_2554;
  DataVector& dv_1683 = temps.at(1516);
  DataVector& dv_2359 = temps.at(1949);
  sc_31 += (-d[1638]) * ((d[1035] + 9.0) * dv_1683 +
                         (-M) * (dv_2359 + dv_3106) + d[167]) +
  ...
  sc_24 += d[1250] * ((-d[1831]) * dv_3103 +
                      (-d[348]) * ((-d[1840]) * dv_1530 + dv_2383 + dv_3104) +
                      (3.0 * M * yp * (d[1068] + d[1620] + 36.0)) * Dx) +
  ...
  sc_24 += d[35] * ((-d[1838]) + d[1] * ((-d[278]) + dv_1683) +
           ...
           d[436] * ((d[1035] + 3.0) * dv_1881 + M * (dv_1503 + dv_2854) +
                     d[1054] + dv_2135);
  sc_16 = d[1841] * sc_24;
  ...
  sc_29 = (d[1267] + d[1842]) * dv_2666 +
          (-d[436]) * ((-M) * (dv_1502 + dv_2821) + (-rpdot - 9.0) * dv_1881 +
                       d[1694] + dv_2829) +
          d[1251] * dv_3053;
  ...
  sc_18 += d[431] * dv_3066 +
           xpdot * ((-d[1843]) * dv_2704 +
                    (-d[259]) * ((-d[1854]) * dv_558 + d[1853] + dv_3079) +
                    (3.0 * d[20]) * ((-M) * (dv_2114 + dv_3109) + d[1460] +
                                     d[1851] * dv_1) +
                    (-d[1629]));
  sc_29 = d[1858] * sc_18;
  ...
  sc_34 += d[1250] *
           ((-d[259]) * ((-rpdot - 3.0) * dv_2468 + d[1853] + 147.0 * dv_794) +
            (-54.0 * d[276]) + d[1849] * dv_3113 +
            d[348] * ((-M) * (dv_2114 + dv_3114) + d[1694] + d[1840] * dv_69));
  ...
  sc_35 =
      (-d[1570]) *
          ((-d[36]) * (d[1418] + dv_1683) + d[1837] +
           d[29] * (M * (dv_2390 + dv_3101 + 6.0) + d[153] + d[1780] * dv_69)) +
      (d[29] * (d[1236] + d[1835] * yp)) * dv_780 +
  ...
  sc_33 = (d[361] * d[557]) * dv_3098 +
          d[1830] * ((d[255] + yp * (d[1242] - d[1829] * ypdot)) * dv_1564 +
  ...
  sc_29 +=
      xpdot * ((d[1068] + d[1189] - 6.0) * dv_3184 +
               (-d[259]) * (d[1934] * dv_69 + dv_3185) +
               d[20] * (d[314] + dv_2547 * rpdot - dv_2769) + d[50] * dv_3053);
  sc_18 = (-d[1797]) * sc_29;
  DataVector& dv_2837 = temps.at(2389);
  DataVector& dv_3045 = temps.at(2489);
  sc_24 = d[35] * ((-56.0 * d[319] + d[500]) + yp * (d[1418] + dv_3045)) +
          120.0 * dv_2837;
  DataVector& dv_2707 = temps.at(2260);
  DataVector& dv_3186 = temps.at(2673);
  sc_24 += xpdot * ((-d[110]) * dv_1112 + (-d[1291] + 52.0 * ypdot) * dv_3105 +
                    d[495] * dv_3186 + d[51] * (dv_2707 + dv_624 * xpddot) +
                    40.0 * dv_2372);
  ...
  sc_24 +=
      yp * ((-d[484]) * (dv_1632 + dv_2772) +
            (-yp) * (d[1460] + d[1933] * dv_1 + dv_1802 + dv_2484 + dv_2686) +
            (2.0 * d[20] * ypdot) * (d[7] + dv_2702 + dv_3101));
  sc_29 = d[1466] * sc_24;
  ...
  sc_16 +=
      xpdot *
      ((-d[20]) * (d[434] + dv_2834 * rpdot - 78.0 * dv_794) +
       (-d[244]) * dv_794 + (2.0 * d[50]) * ((-d[1608]) + dv_2728 + dv_2968) +
       (3.0 * M * yp) * ((d[1937] + 8.0) * dv_69 + d[153] - dv_3072));
  sc_24 = d[1800] * sc_16;
  ...
  sc_31 =
      (-d[1286]) * dv_2298 +
      (-d[259]) *
          ((-d[1936]) * dv_3189 + (M * d[1447]) + d[484] * dv_3078 + dv_3193) +
      (-d[276]) * (d[1368] + dv_1502 + dv_2842) +
      (-xpdot) * ((d[1029] * d[514] - d[110] * (d[1620] + 12.0) +
  ...
  sc_31 += (6.0 * d[48] * ypdot * (d[1368] + d[1854])) * Dy +
  ...
  sc_32 += xpdot * ((d[1946] + 310.0 * d[196] + d[244] * (d[1189] + 10.0) +
                     d[259] * (d[1258] + 128.0 * ypdot) +
                     rpdot * (d[138] + 234.0 * d[159] - d[1954])) *
                        Dx +
                    d[1935] * dv_1808);
  sc_31 = d[1807] * sc_32;
  ...
  sc_35 +=
      ...
      xpdot *
          ((d[1396] + d[1792] * (234.0 * d[36] - 95.0 * yp) + 298.0 * d[196] +
            d[259] * (d[1258] + d[1685]) + 21.0 * d[48] * (d[1580] + 6.0)) *
               Dx +
           (d[244] + d[248]) * dv_1808);
  sc_32 = d[1812] * sc_35;
  ...
  sc_36 += xpdot * ((-d[20]) * (d[434] + dv_3130 * rpdot - 296.0 * dv_794) +
  ...
  sc_37 = (d[1813] * d[510] - 127.0 * d[3]) * dv_3186 +
          (d[1941] * d[77] + d[1947] * ypdot + 370.0 * d[319]) * dv_780 +
  ...
  sc_37 +=
      xpdot * ((d[1068] + d[1949] + 24.0) * dv_3184 +
  ...
  sc_34 = (-d[1289]) * dv_3180 +
          (-d[1581]) * ((-d[1247] + d[1375] + d[1933] * ypdot) * dv_231 +
                        (-d[1932]) * dv_780 + d[1432] + d[319] * dv_2392 +
                        d[86] * ((-yp) * (dv_2700 + dv_3101) + d[314] +
                                 d[7] * (d[1506] + dv_538)) +
                        dv_3183);
  ...
  sc_36 += (d[19] * d[50]) * ((15.0 - rpdot) * dv_780 + Dx * d[1782] +
  ...
  sc_36 += (d[55] * yp) * ((d[1068] + 39.0) * dv_780 + (-d[1783]) * Dx +
  ...
  sc_18 = (-d[101]) * ((-891.0 * rpdot - 200.0) * dv_1 + dv_3199) +
          (-d[273]) * ((d[1998] + 16.0) * dv_538 + d[1731] - 1488.0 * dv_794) +
          (-d[51]) * ((-M) * (dv_2982 + dv_3215 + 4.0) + (-d[1971]) * dv_1881 +
                      d[1664]) +
          (-d[1996]);
  ...
  sc_37 = (-d[1412]) *
              (M * (dv_2844 + dv_3207 + 4.0) + d[1403] + d[1973] * dv_1552) +
  ...
  sc_29 = d[1250] *
              ((-d[151]) * dv_3206 + (-d[1291] + d[1970] * ypdot) * dv_2445 +
               (4.0 * d[50]) * (d[1971] * dv_1514 + dv_2347 + 35.0 * dv_2375) +
               (10.0 * M * d[20] * (d[1781] - 4.0)) * Dx) +
          600.0 * dv_2442 + sc_18;
  sc_29 += d[35] * ((-d[243]) * ((-d[1829]) * dv_538 + (170.0 * M * ypdot)) +
                    (d[1389] + 72.0 * d[50]) + 573.0 * dv_3126);
  sc_24 = d[1466] * sc_29;
  DataVector& dv_2545 = temps.at(2133);
  DataVector& dv_3204 = temps.at(2691);
  sc_18 = (d[1505] - ypdot * (d[155] + d[1965])) * dv_3105 +
  ...
  sc_18 +=
      d[86] *
      ((-M) * (d[1731] + dv_3075 - 111.0 * dv_794) + (48.0 * d[319]) +
       yp * ((-62.0 * d[255]) + M * (120.0 * dv_1502 + 37.0 * dv_1503 + 16.0) +
             d[1967] * dv_2227));
  sc_29 = d[1581] * sc_18;
  ...
  sc_37 +=
      d[276] * ((-d[1974]) + M * (37.0 * dv_1502 + 120.0 * dv_1503 + 16.0) +
                d[1964] * dv_582);
  DataVector& dv_2491 = temps.at(2079);
  sc_37 +=
      d[286] * ((M * d[367]) * (d[1567] + dv_2491) +
  ...
  sc_40 += d[58] * ((-200.0 * d[255]) + M * (dv_2733 + dv_3222 + 8.0) +
                    d[1999] * dv_582);
  ...
  sc_39 += d[1393] * (M * (81.0 * dv_1502 + dv_3017 + 8.0) + d[1734] +
                      d[1999] * dv_1881) +
           d[1983] * dv_3208;
  DataVector& dv_2589 = temps.at(2164);
  sc_39 += d[6] * ((-d[1105]) * ((-d[1999]) * dv_538 + (100.0 * M * ypdot)) +
  ...
  sc_39 += d[631] * ((-d[2000] - 4.0) * dv_1683 + d[1815] + d[257] * dv_2343 +
                     dv_3218) +
           xpdot * ((d[101] * (d[1258] + 200.0 * ypdot) +
                     d[1450] * (469.0 * d[7] - 32.0) +
                     d[1700] * (d[2002] - 28.0 * ypdot) +
  ...
  sc_40 += d[1411] * ((-d[2006]) + M * (57.0 * dv_1503 + dv_3207 + 12.0) +
                      d[1829] * dv_1683) +
  ...
  sc_35 =
      (M * d[1328]) * dv_3180 +
      d[1931] * ((37.0 * d[255] + yp * (d[1316] + d[1343] * d[1963])) * dv_0 +
                 (d[1311] * xpddot) * dv_231 + (-d[1311] * d[1605])) +
  ...
  sc_21 +=
      (-d[74]) * (d[1210] * ((-xpdot) * dv_2121 + dv_2120) + dv_2139 +
                  xp * ((-d[81]) * dv_2117 + dv_2116 + 6.0 * dv_3057 +
                        xpddot * ((-d[1269]) * dv_547 + dv_2119 + dv_555))) +
      sc_2 + sc_8;
  ...
  sc_5 = (4.0 * d[1041]) * dv_1921 + (d[1108] * d[549]) * dv_1865 +
         ...
         (90.0 * d[208] * rpdot) * dv_1742 +
         (54.0 * d[16] * d[22] * rpdot) * dv_1916 + d[1097] * dv_1784 +
  ...
  sc_5 += -dv_1764 * ((-d[12]) * dv_1539 + (d[10] * rpdot) * dv_75 +
                      (d[12] * d[9]) * dv_1577 +
                      d[21] * (d[6] * dv_1763 + dv_1575 +
                               xpdot * (-Dx * dv_1761 + d[1085] * dv_58)) +
                      dv_1584);
  ...
  sc_3 =
      (d[1044] * d[24]) * ((-d[1046]) * dv_1525 + (-d[1046]) * dv_1534 +
                           (d[39] * d[688]) * dv_1526 + d[1035] * dv_83 +
  ...
  sc_3 +=
      (-7.0 / 12.0 * d[1047] * d[1074]) * dv_1740 +
      (-7.0 / 48.0 * d[1026]) * dv_1609 * dv_225 * dv_3772 +
      ((1.0 / 8.0) * d[1041] * 1.0 / (d[16] * d[16] * d[16] * d[16]) * 1.0 /
       d[577]) *
          dv_1611 * dv_3772 +
      ((13.0 / 16.0) * d[1025] * d[1074] / pow(rp, 31.0)) * dv_1611 * dv_3771 +
  ...
  sc_4 +=
      d[54] * ((-d[53]) * dv_3809 +
               d[52] * (-dv_2181 + yp * (dv_3804 * ypdot - dv_764)) +
               d[63] * ((xpdot * yp) * dv_3806 - dv_3805) + dv_3802 + dv_3803);
  ...
  sc_21 = (d[1059] * d[5] + d[2442] * d[68] + xpdot) * dv_1597 +
  ...
  sc_17 += (d[57] * xp) * Dx * (d[114] * dv_2046 + d[118] * dv_2090 + dv_3974) +
           (d[120] * rp) * Dy *
  ...
  sc_6 += (d[122] * rp) * Dy * (d[578] * dv_184 + d[9] * dv_2058) -
  ...
  sc_7 = (-xp) * dv_3970 + d[1060] * dv_3963 + dv_3776 * dv_3971 +
  ...
  sc_34 = (-10.0 * d[52]) * dv_0 +
          ...
          xp * (d[2580] * dv_0 + d[2582] * dv_1 + dv_3853);
  DataVector& dv_34 = temps.at(34);
  sc_34 += yp * ((-d[1723]) * dv_231 + d[1096] * dv_752 +
                 ypdot * ((-d[938]) * Dx + d[648] * dv_34));
  sc_7 = (-d[2583]) * sc_34;
  sc_17 = d[2668];
  ...
  sc_36 +=
      d[1863] * ((d[1443] * (55.0 - d[2670]) + d[1490] * ypdot -
      ...
      d[1905] *
          ((-d[1251] * d[7] + d[1443] * d[2672] + d[272] + 166.0 * d[274]) *
           ...
           (128.0 * M * yp * ypdot - d[416] - 94.0 * d[48]) * dv_263) +
      d[1931] * dv_265 + sc_17;
  ...
  sc_17 =
      d[19] * ((d[1] * (d[1371] + 4.0) - d[3] * (d[1680] + 29.0)) * dv_2170 +
               d[1928] * dv_752) +
      d[52] * ((-d[2585]) * dv_2118 + (12.0 * d[6] * ypdot) * Dy - dv_2479);
  sc_17 += xp * (Dy * d[1915] + d[2586] * dv_1696 + d[62] * dv_1541);
  DataVector& dv_3024 = temps.at(2485);
  sc_17 += yp * ((d[138] - d[388]) * dv_752 + (-d[62]) * dv_2379 +
                 d[2587] * (dv_126 * xpdot + 28.0 * dv_2443) +
  ...
  sc_12 +=
      (M * d[59]) * (d[1775] * dv_265 + d[319] * (dv_1727 + dv_3881) +
                     d[436] * (dv_1530 + dv_3880)) +
      d[1199] * ((M * d[20] * d[2145] - d[2146]) * Dy +
  ...
  sc_6 +=
      ...
      d[127] * ((d[1416] + d[1433] + d[2003]) * dv_2118 +
                (-24.0 * d[1339] - d[1986] * d[287] - d[2615] * ypdot +
                 d[463] * d[50]) *
                    Dy +
                dv_3895) +
      d[128] *
  ...
  sc_13 =
      ...
      (d[1931] * ypdot) * (d[2674] * dv_2672 + dv_3915);
  ...
  sc_13 += d[2004] * ((-d[1716] * d[6] - d[2233] * d[273] + d[2234]) * Dx +
           ...
           d[2011] * ((d[1711] * d[286] - d[2237] * d[273] + d[2691]) * Dx +
                      d[2690] * dv_3910) +
           d[2673] * dv_3245;
  sc_13 += d[2678] * ((2.0 * d[1681] * yp - 245.0 * d[36]) * dv_1564 +
                      (-d[2676]) * Dy + Dy * d[2677]);
  sc_6 = d[377] * sc_13;
  sc_28 = (d[1514] * d[340]) * dv_3915 + (d[1830] * d[2058]) * dv_752 +
          d[1177] * ((-d[1549] * d[2661] - d[1981] * d[2660] + d[2317] +
                      d[252] * d[811] + d[885] * ypdot) *
                         Dy +
                     (56.0 * M * yp * ypdot - d[110] - d[370]) * dv_3637 +
                     d[2088] * dv_0);
  ...
  sc_30 += (d[1618] * xp) * ((d[1637] + d[1819] + d[564]) * Dy +
