...
void puncture_field_generic_1(
  ...
  dv_117 = dv_115 - dv_116 * dv_17 + 2 * (dv_17 * dv_17);
  ...
  dv_123 = dv_115 - dv_118 * dv_16 + 2 * dv_121 + 2 * dv_122;
  ...
  dv_128 = 11 * dv_114 + 11 * dv_121 + dv_125 * dv_15 - dv_127;
  ...
  dv_155 = d_43 * dv_153 + d_49 * dv_154 + dv_110 * dv_79 - 12 * dv_152;
  ...
  dv_195 = d_22 * d_38 * dv_19 * dv_60 + d_25 * dv_60 * dv_62 + dv_194 * rp -
           9 * dv_45 * dv_92 - dv_46 * dv_48 - dv_46 * dv_64 + dv_49 * dv_51 +
  ...
  dv_212 =
      -d_65 * (2 * M * dv_2 * dv_6 * rp + 3 * d_13 * dv_10 * rpdot -
               d_25 * dv_205 - dv_204 -
  ...
  dv_230 =
      2 * d_4 * dv_222 +
      d_82 *
          (xpdot * (dv_162 - dv_228 * dv_54 + xp * (dv_229 + dv_36)) +
           ypdot * (dv_143 - dv_55 * (dv_170 + xp) + yp * (dv_38 + 2 * dv_4)));
  ...
  dv_259 = 16 * d_10 * dv_251 + 16 * dv_250 +
           16 * xpdot *
               (Dx * (-dv_258 - yp * (Dy + d_88 * yp)) - dv_257 +
                dv_57 * xpddot + xp * (Dy * (Dy + yp) + d_69 * dv_16 + dv_72)) +
           16 * ypdot *
               (d_87 * dv_14 + d_87 * dv_16 + dv_235 * xpddot + dv_252 +
  ...
  dv_278 = -d_17 * dv_99 - d_18 * dv_104 + 14 * dv_277;
  ...
  dv_288 = d_73 * dv_269 - dv_230 + 2 * dv_267 * rpdot;
  ...
  dv_394 = -d_10 * dv_143 + d_33 * dv_0 + dv_252 - dv_255 * (d_10 + 1);
  ...
  get(get<CurvedScalarWave::Tags::Psi>(*result)) =
      dv_21 * ((1.0 / 2.0) * d_16 * dv_43 * dv_45 -
               1.0 / 24.0 * d_21 * dv_195 * dv_45 + 1);
      ...
      (d_21 * d_84 * dv_214 * dv_231 + d_79 * dv_214 * dv_91 -
       ...
       dv_232 *
           (M * dv_259 * dv_85 + d_15 * dv_237 * dv_245 +
            ...
            dv_233 * dv_48 * rpdot + 32 * dv_234 * dv_51 - 44 * dv_234 * dv_64 +
            80 * dv_234 * dv_66 + dv_244 * dv_249 * d_83 * rp * rp -
            36 * dv_247 * dv_86 - dv_248 * dv_49 * d_83 * rp * rp * rp -
            dv_264 * dv_286 -
            18 * dv_284 * dv_45 *
                (d_13 * dv_270 * dv_9 * rpdot - d_86 * dv_227 * dv_270 -
                 dv_211 * dv_288 + dv_217 * dv_269 * rp - dv_223 -
                 dv_241 * dv_287 * rp + 2 * dv_269 * dv_6 * rpdot) +
            dv_286 * (3 * d_13 * d_65 * dv_10 * rpdot - d_5 * dv_285 * dv_7 -
                ...
                (-d_0 * d_98 * dv_287 * dv_288 +
                 d_100 * dv_193 *
                     (-d_19 * dv_187 * dv_217 - d_71 * dv_187 * dv_6 -
                      dv_184 * xpddot -
                      dv_188 *
                          (-M * d_77 * dv_18 + d_1 * dv_3 + 16 * d_102 * dv_12 +
                           12 * d_25 * dv_2 + d_41 * dv_309 +
                           16 * d_6 * dv_309 + d_7 * dv_218 * dv_6 +
                           d_71 * dv_106 - 24 * d_99 * dv_18) +
                      dv_274 * ypddot +
                      xpdot *
                          (6 * d_40 * dv_12 * dv_285 * xp -
                           d_6 * (xpdot *
                                      (d_43 * (dv_329 - dv_332 * yp) -
                                       d_44 * dv_170 *
                                           (20 * dv_15 + dv_233 + dv_290 +
                                            27 * dv_5) +
                                       d_49 * (-9 * Dy * dv_178 + dv_333 * yp) +
                                       d_90 * dv_4 * (18 * Dy * yp - dv_181) +
                                       dv_331) +
                                  ypdot *
                                      (20 * Dx * dv_131 +
                                       d_104 * (dv_329 + dv_330) +
                                       ...
                                       2 * dv_298 * (dv_181 + 34 * dv_5))) -
                           d_89 * dv_183 -
                           dv_156 *
                               (d_103 * (-d_26 * (dv_167 + 5 * dv_5) +
                                         d_44 * dv_79 + 6 * dv_162 * dv_216 +
                                         dv_326 * (-d_80 - dv_219)) +
                                xpdot * (8 * Dx * dv_262 * xp * yp -
                                         3 * d_17 * (dv_165 + dv_35) +
                                         d_18 * (2 * Dy * yp - dv_167) -
                                         6 * dv_110)) -
                      ...
                      ypdot *
                          (d_6 *
                               (d_43 *
                                ...
                                d_49 * (dv_0 * (54 * dv_15 + 36 * dv_16 +
                                                dv_177 + dv_308) +
                                        ypdot * (-dv_323 * yp + dv_324)) +
                                d_52 * (9 * dv_314 * (dv_146 + dv_22) +
                                        xpdot * (-d_35 * dv_325 + dv_324))) +
                           d_89 * dv_273 + dv_155 * dv_312 + dv_155 * dv_313 +
                           dv_156 * (d_17 * (2 * dv_0 * (dv_219 + 5 * yp) +
                                             ypdot * (-dv_132 - dv_316 -
                                                      8 * dv_5 - dv_67)) +
                                     d_18 * (-4 * dv_0 * dv_262 +
                                             3 * ypdot * (dv_153 + dv_229)) +
                                     d_31 * xp *
                                         (6 * dv_314 * (-d_80 - dv_79) +
                                          xpdot * (dv_154 + dv_22)) -
                                     2 * d_44 * (dv_314 + dv_315)) +
                           dv_285 * dv_311 * yp - dv_310 * ypdot)) +
                 4 * d_100 * dv_275 *
                     (2 * M * d_5 * d_73 * dv_6 - d_4 * d_5 * dv_289 -
                      d_4 * d_65 * d_98 * dv_6 * rpdot - d_58 * dv_289 -
                      d_7 * dv_202 * rpdot - d_72 + dv_206 + dv_207) +
                 d_13 * d_99 * dv_193 * dv_275 +
                 8 * d_22 * d_86 * dv_192 * dv_275 -
                 d_24 * d_86 * d_98 * dv_271 + dv_280 * rpdot +
                 rp * (8 * d_102 * dv_279 +
                       d_54 *
                           (xpdot *
                                (d_44 *
                                     (-dv_14 * (22 * dv_16 + dv_300 + dv_301) +
                                      dv_17 * (dv_302 + dv_98) + dv_299) +
                                 d_52 * (15 * Dy * yp * (-dv_15 + dv_16) -
                                         dv_128 + dv_14 * (dv_126 + dv_300)) -
                                 dv_160 * (15 * dv_108 + dv_294 * yp) + dv_293 +
                                 dv_298 * (-45 * dv_295 + dv_297 * yp)) -
                            ypdot *
                                (-d_18 * dv_306 *
                                     (-dv_219 * dv_38 + dv_305 * yp) -
                                 d_43 *
                                     (-d_101 * dv_307 + 4 * dv_121 + dv_127 +
                                      dv_14 * (-dv_301 + dv_49 + 11 * dv_5) -
                                      dv_16 * dv_301 + dv_291 * dv_5 + dv_299) +
                                 d_49 * (-dv_125 * dv_5 + dv_128 +
                                         dv_14 * (dv_296 + dv_308) -
                                         22 * dv_307 * yp) +
                                 15 * dv_110 * (dv_295 - dv_304 * yp) +
                                 dv_131 * dv_303)) +
                       dv_106 * dv_278 * rpdot + 8 * dv_150 * dv_217 -
                       dv_186 *
                           (xpdot * (3 * dv_162 - dv_54 * (7 * Dy + d_101) +
                                     xp * (7 * dv_5 + dv_99)) +
                            ypdot * (d_18 * dv_219 - dv_55 * (7 * Dx + 4 * xp) +
                                     yp * (dv_104 + 7 * dv_4))) +
                       dv_218 * dv_278 * dv_7))));
  get<0>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      (d_111 * dv_201 * dv_377 * (dv_43 * dv_43) -
       d_113 * dv_361 *
           (2 * d_40 * dv_93 - d_42 * dv_42 * dv_42 - d_48 * dv_130 -
       ...
       dv_362 * dv_42 * dv_89 -
       dv_379 * dv_43 *
           (d_13 * d_62 * dv_42 + 2 * dv_335 * dv_6 - dv_338 -
            dv_354 * dv_378) -
       dv_391 *
           (3 * M * d_13 * d_6 * dv_354 * dv_88 +
            M * dv_6 * rp * (d_44 * dv_165 + d_52 * dv_167 + dv_161 - dv_164) +
            2 * d_6 *
                (d_44 * dv_302 * (dv_17 + dv_96) + dv_172 * dv_380 +
                 15 * dv_176 * (dv_16 + dv_29 + dv_95) + dv_182 * dv_297 +
                 dv_293) -
            dv_159 - dv_191 * (d_107 * d_51 + d_5 * d_61 + xpdot) -
            dv_89 * (d_114 * dv_383 +
                     d_50 * (-d_44 * (-d_3 * dv_387 + dv_386) -
                             d_52 * (-d_3 * dv_389 + dv_388) +
                             4 * dv_1 * dv_292 - dv_229 * dv_385 + 4 * dv_384 +
                     ...
                     d_6 * (-d_104 * (M * dv_97 - d_3 * dv_325) -
                            ...
                            dv_35 * dv_385 + 20 * dv_384 +
                            xpdot * (-d_46 * dv_332 + d_47 * dv_333 -
                                     54 * dv_111 + dv_331 + 36 * dv_390)) +
  ...
  get<1>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      (-dv_203 * dv_213 + dv_203 * dv_369 - dv_203 * dv_377 * dv_404 +
       ...
       dv_379 * dv_91 *
           (-dv_378 * dv_398 + 2 * dv_392 * dv_6 + dv_393 - dv_399) -
       dv_391 *
           (-d_6 * d_84 * dv_226 * dv_398 +
            d_97 *
                (Dy * d_45 * dv_303 - Dy * d_46 * (dv_116 + dv_291 + dv_316) -
                 d_43 * dv_305 * dv_306 -
                 dv_144 * (dv_125 - 68 * dv_14 + dv_301) -
                 15 * dv_304 * dv_406) +
                ...
                (d_114 * dv_407 +
                 d_50 *
                     (-d_43 * (-d_3 * (dv_145 + dv_31) + dv_388) +
                      ...
                      6 * dv_152 * (d_1 + 5 * d_3) + dv_406 * dv_408 +
                      xpdot * (d_43 * dv_389 * xp + d_44 * dv_387 * yp +
                               dv_131 * dv_409 - 34 * dv_143 * dv_162 +
                               dv_172 * dv_320)) +
                 d_6 *
                     (-d_104 * (Dx * dv_79 * (9 * d_3 + d_7) - dv_330 * xpdot) +
                      d_35 * d_44 * (Dx * dv_408 + dv_328 * xpdot) +
                      2 * d_43 *
                          (Dy * (-Dy * d_98 + dv_0 * yp) + d_3 * dv_321) +
                      d_45 * (20 * Dy * dv_0 + dv_317) -
                      d_49 * (-d_3 * dv_323 +
                              dv_409 * (M * dv_221 + 17 * dv_5 * xpdot))) +
  ...
  get<2>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      -1.0 / 24.0 * z *
      (-M * dv_260 *
           (3 * d_115 * d_117 * d_13 * d_50 * (d_4 * dv_33 + dv_40) +
            d_115 *
                (dv_106 + rp * (-d_17 * dv_303 + d_18 * dv_380 + 30 * dv_277)) -
            dv_378 * (d_115 * d_60 * dv_6 +
                      d_115 * rp *
                          (xpdot * (5 * dv_162 + dv_22 * xp + dv_353) +
                           ypdot * (5 * dv_143 + 6 * dv_252 + dv_256)) +
                      d_55 * dv_6 + d_56 * dv_6)) *
           1.0 / d_39 +
       d_105 * d_109 * dv_411 + d_106 * d_8 * dv_282 + d_108 * d_116 * dv_411 +
       d_110 * d_115 * dv_198 * (-dv_413 + dv_6) +
       d_116 * d_78 * dv_19 * dv_61 - d_38 * dv_282 + 48 * d_5 * dv_106 -
       d_5 * dv_19 * dv_62 + d_59 * d_8 * dv_412 + d_65 * dv_412 -
       d_7 * dv_374 * dv_63 - d_78 * dv_410 * dv_413 - 24 * dv_11 + 24 * dv_14 +
       24 * dv_15 - dv_260 * dv_368 + dv_336 * dv_410 - dv_359 * dv_63 +
       dv_364 + dv_365 - dv_367 - dv_370 * dv_376 - dv_372 + dv_401 - dv_403 +
       dv_404 * dv_44 - dv_405 + dv_46 * dv_65) /
