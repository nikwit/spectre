...
void puncture_field_2_part_8(const std::array<double, order2_n_doubles>& d,
  ...
  sc_28 += (-d[996]) * ((-d[1291]) * (dv_2629 + dv_565) - dv_1762 * dv_2793 +
                        dv_2948 + ypdot * (d[2344] * dv_14 + d[2345] * dv_15));
  ...
  sc_10 =
      ...
      d[1172] * ((d[1680] * d[2301]) * dv_45 +
                 d[36] * (192.0 * dv_3270 - 2.0 * dv_3582 + dv_802 * xpddot) +
                 dv_3264 + dv_3540) +
      dv_3445 + sc_13;
  ...
  sc_10 +=
      d[1549] * ((-d[1]) * (21.0 * dv_3138 + xpddot * (dv_128 - 52.0 * dv_15)) +
  ...
  sc_10 += -dv_2667 * ((-d[273]) * (d[1578] + d[2339] * dv_1552) +
                       (-d[283]) * (d[1567] + dv_2800) +
                       (3.0 * d[50]) * (Dy * d[2337] + d[1712]) +
                       (12.0 * d[48] * yp) * ((132.0 * d[36]) + Dy * d[2340]) +
                       (-d[1659]));
  sc_16 = (d[122] * yp) * sc_10;
  ...
  sc_2 = (-d[996]) * (Dx * ((366.0 * rpdot + 7.0) * dv_2481 +
                            (-d[1]) * dv_2797 + d[2350]) -
                      dv_3363 + dv_3371) +
         d[120] * dv_2828;
  ...
  sc_2 = (-d[1088]) * dv_2606 + (-d[416]) * dv_3411 +
         d[1191] * (Dx * (M * dv_3265 + d[1966] * dv_1552 + d[255]) +
  ...
  sc_2 += Dx * d[1248] *
              ((-yp) * (d[1832] * dv_972 + d[444]) + (-d[524]) - dv_2186) -
  ...
  sc_29 += d[287] * ((-ypdot) * ((-d[2160]) * dv_15 + d[2331] * dv_14) +
                     d[1242] * dv_724) +
  ...
  sc_26 += d[77] * ((-d[1]) * ((-xpddot) * (dv_486 + dv_61) + 131.0 * dv_3138) +
  ...
  sc_28 =
      d[1652] * (Dy * ((-69.0 * yp) + dv_2234) + 272.0 * dv_14) + sc_17 + sc_29;
  ...
  sc_8 +=
      (2.0 * M * d[340] * d[6]) * ((-d[631]) * dv_3597 + d[230] * dv_1 +
                                   d[50] * ((-d[1106]) * dv_3598 + dv_1762) -
                                   dv_3154 + 348.0 * dv_3227) +
      sc_13 + sc_2;
  DataVector& dv_2617 = temps.at(2199);
  DataVector& dv_2647 = temps.at(613);
  sc_8 += (d[1618] * xpdot) * Dx *
  ...
  sc_24 += ypddot * ((-d[1362]) * dv_591 + d[29] * dv_561 + dv_3176 * yp);
  sc_16 = (-M) * sc_24;
  ...
  sc_6 += d[77] * ((12.0 * d[147]) * dv_16 + (80.0 * rpdot * ypdot) * dv_525 -
  ...
  sc_16 = (-d[1402]) * ((-M) * dv_2253 + (50.0 * d[280] * rpdot) * dv_16) +
  ...
  sc_16 += -dv_3065 * ((-d[169] + 320.0 * rpdot + 25.0) * dv_5 +
  ...
  sc_2 += (-d[930]) * dv_1547 + (-172.0 * d[604]) * dv_3175 +
          ...
          (720.0 * rpdot) * dv_3157 + (d[1030] * d[1543]) * dv_594 +
  ...
  sc_2 += (86.0 * d[48]) * dv_1017 * dv_1503 +
          d[52] * ((-M) * dv_2232 + (-d[1081] * xpdot) * (dv_1200 + dv_2196) +
                   d[1240] * dv_2228) +
  ...
  sc_16 = d[1250] *
              ((-yp) * (Dy * (d[1189] + dv_2700) + dv_2302) + dv_3514 * ypdot) +
          d[2241] * dv_3205 + dv_1513 * dv_2498 + 20.0 * dv_2606 + dv_3346;
  sc_16 += ypdot * ((d[1739] + d[2240]) * dv_45 + d[27] * dv_3262);
  sc_13 = (-d[1581]) * sc_16;
  ...
  sc_12 = d[1322] *
          (Dx * ((-127.0 * d[255]) + M * (dv_3544 + 29.0) - dv_2730 - dv_3545) +
  ...
  sc_24 += d[1107] * (dv_3479 + dv_3533 * ypdot) +
  ...
  sc_24 += dv_2942 * ((-d[20]) * (203.0 * Dy + d[2245]) +
                      (32.0 * M * yp) * (d[46] + dv_2291) + (38.0 * d[50]) -
                      56.0 * dv_1821);
  sc_16 = (-d[299]) * sc_24;
  ...
  sc_12 += -dv_2350 *
           ((-d[20]) * (d[314] + dv_3219) + (-d[1100] - d[2242]) * dv_2666 +
            (2.0 * d[50]) * dv_1576 + (4.0 * M * yp) * dv_3515);
  sc_24 = (-d[340]) * sc_12;
  ...
  sc_14 +=
      d[1472] *
      (Dx * ((5.0 * ypdot * (d[2156] - 83.0)) * Dy + M * dv_2743 - dv_2744) +
  ...
  sc_14 +=
      ...
      ((-d[37]) * (Dx * (128.0 * dv_1503 - 145.0) + 64.0 * dv_1583 + dv_3550) +
       (256.0 * M * d[147]) * Dx + (942.0 * d[7]) * Dx * Dy - 705.0 * dv_3294);
  ...
  sc_6 +=
      ...
      d[2202] * dv_258 +
      dv_2942 *
          ((-d[20]) * (d[1751] + dv_2802) + (4.0 * M * yp) * (M + dv_2914) +
           (-d[2173]) - 470.0 * dv_1821) +
      sc_14;
  sc_12 = (-d[342]) * sc_6;
  ...
  sc_28 =
      d[20] * ((-d[1]) * (dv_2030 * xpddot + dv_3138) +
  ...
  sc_29 += d[1865] * ((-d[434]) * dv_3266 + (13.0 * yp) * dv_635) +
  ...
  sc_28 +=
      (-d[20]) * ((-d[1484]) * dv_45 + (d[9] * xpddot) * (-dv_149 - dv_30) +
  ...
  sc_18 = (-d[1490]) * dv_3247 +
          (-d[50]) * (d[153] * (-83.0 * Dx + dv_3529 + dv_3550) +
                      d[9] * (83.0 * dv_3138 + xpddot * (dv_449 + dv_454)) -
  ...
  sc_17 *=
      ...
      Dy * ((-d[1443]) * (d[88] + 897.0 * dv_1) +
            (-d[51]) * ((-M) * dv_3018 + d[1588] + dv_2642) + (d[401] * ypdot) +
  ...
  sc_25 = (-d[1472]) *
          (Dx * ((-M) * (dv_3544 - 3.0) + d[1639] + dv_2720 + dv_3545) +
  ...
  sc_25 += (4.0 * d[48] * yp) * Dx *
               ((-d[2256]) * dv_2044 + d[314] + 1701.0 * dv_794) +
           (32.0 * d[151] * d[2266] * ypdot) * Dx * Dy;
  sc_26 = sc_25 * xpdot;
  ...
  sc_26 = (-d[50]) * (d[153] * (-65.0 * Dx + dv_3542 + dv_703 * xpddot) +
                      d[9] * (65.0 * dv_3138 + xpddot * (dv_115 + dv_480)) -
  ...
  sc_26 += (2.0 * d[142] * yp) * (Dy * ((-d[436]) * (d[1540] + dv_2245) +
                                        (32.0 * d[20]) * (Dy + d[31]) +
  ...
  sc_26 +=
      (2.0 * d[57] * ypdot) * (58.0 * dv_3138 + dv_3522 - dv_3552) +
      (4.0 * d[48] * yp) * ((-d[9]) * (dv_3506 + dv_3553) + d[2262] * dv_3237 +
  ...
  sc_26 +=
      ...
      ((-d[287]) * (d[9] + 1215.0 * dv_1) +
       (-d[50]) * (d[1748] + d[88] * dv_2754 + dv_3499) + (d[834] * ypdot) +
  ...
  sc_14 += d[355] * ((-ypdot) * (d[2067] * dv_15 + d[2068] * dv_14) + dv_3233) +
  ...
  sc_14 = M * (d[1106] * ((7.0 * ypdot) * dv_635 - dv_2650) +
               yp * (21.0 * dv_2301 + dv_240 * ((-d[1814]) + dv_2431))) +
          d[2050] * dv_3098;
  DataVector& dv_3068 = temps.at(2561);
  DataVector& dv_3254 = temps.at(2741);
  sc_14 += dv_0 * ((-d[354]) * ((17.0 * d[36]) + 66.0 * dv_3068) + M * dv_3254);
  sc_18 = (-d[1466]) * sc_14;
  ...
  sc_28 = (-88.0 * d[1792]) *
              ((M * d[99] * yp) * dv_635 + d[252] * dv_1731 + d[348] * dv_740) +
          sc_12 + sc_6;
  ...
  sc_28 += d[162] * dv_2349 * ((26.0 * yp) - dv_1637);
  sc_14 = (-d[299]) * sc_28;
  ...
  sc_16 = (d[1217] + 75.0 * d[7] - 8.0) * dv_3154 +
          (-d[1443]) * ((-d[1242]) * dv_669 + d[255] * dv_2512 +
                        ypdot * (d[2067] * dv_14 + d[2068] * dv_15)) +
          d[451] * dv_1;
  DataVector& dv_3283 = temps.at(2770);
  sc_16 += d[50] * ((-d[2069] - 10.0) * dv_2937 + (-6.0 * M) * Dy * dv_3283 +
  ...
  sc_13 += (-d[724]) *
           ((-d[2056]) * dv_45 +
            (-d[484]) * (Dx * dv_3291 + dv_594 * xpddot + dv_99 * xpddot) +
  ...
  sc_13 += d[50] * ((-d[1221]) * dv_3262 + (26.0 * M * d[7]) * Dx - dv_3261 -
                    dv_3285) +
           dv_3284 *
               ((30.0 * ypdot) * (dv_2497 + dv_751) + (-d[2000] * d[532]) * Dx);
  sc_16 = sc_13 * yp;
  ...
  sc_25 =
      (-d[1172]) *
          ((36.0 - 143.0 * rpdot) * Dy + (-d[2082]) * dv_794 + (63.0 * d[36])) +
      (-d[1549]) *
          ((-d[166]) * (dv_2432 + 9.0) + (714.0 * d[255]) + d[2076] * dv_2387);
  DataVector& dv_2470 = temps.at(2059);
  sc_25 += (-d[1669]) * ((517.0 * rpdot - 26.0) * dv_1 +
                         (-d[1]) * (dv_2470 + 8.0) + d[1400]) +
           (720.0 * d[384] * d[7]) * Dy + d[57] * (d[2064] + 264.0 * dv_3068);
  sc_17 = Dy * sc_25;
  sc_13 = (d[1] * (d[2091] * (d[2090] - 12.0) +
                   d[287] * (d[2092] + d[266] * ypddot) +
                   d[50] * (78.0 * d[1242] - 175.0 * ypdot) +
                   d[807] * (d[2089] - 16.0)) +
           d[2000] * d[2088]) *
              dv_29 +
  ...
  sc_16 += d[1549] * ((-d[1580] * d[2070]) * dv_45 +
                      d[403] * (dv_129 * xpddot + dv_3296 * (dv_2432 + 3.0) +
                                dv_656 * xpddot) -
                      306.0 * dv_3263 + 264.0 * dv_3294);
  DataVector& dv_343 = temps.at(326);
  DataVector& dv_729 = temps.at(678);
  sc_16 += d[355] * ((-d[2086]) * dv_3247 +
                     d[37] * (dv_343 * xpddot + dv_352 * xpddot + dv_729) +
                     462.0 * dv_3294);
  sc_16 += d[57] * ((-d[1587]) * dv_3262 + (99.0 * M * d[7]) * Dx -
                    99.0 * dv_3260 - dv_3293) +
           sc_24;
  DataVector& dv_3259 = temps.at(2746);
  sc_16 += -dv_3259 * ((-d[724]) * (d[2084] * dv_69 + d[42]) +
                       (d[48] * yp) * (Dy * d[2086] + d[1752]) + (-d[451]) +
  ...
  sc_17 =
      ...
      d[1494] * (d[290] * dv_2220 + dv_3310 * ypdot) + dv_3309;
  DataVector& dv_2449 = temps.at(2038);
  sc_17 += d[276] * ((48.0 * M) * Dy * dv_2449 + (600.0 * M * ypddot) * dv_635 -
  ...
  sc_13 +=
      d[1411] * ((12.0 * M) * Dy * dv_3275 + (24.0 * M * ypddot) * dv_3321 -
  ...
  sc_25 = d[162] * dv_2837 * (dv_3133 + yp) +
  ...
  sc_17 += M * (d[20] * dv_2843 + d[314] * (d[2053] * dv_3266 + dv_833) +
                d[354] * ((-d[255]) * dv_2547 + (3.0 * M) * Dy * dv_3267 +
                          (12.0 * M * ypddot) * dv_3266 - 55.0 * dv_740));
  sc_13 = sc_17 * xpdot;
  sc_23 = (-d[162]) * dv_2606 +
          d[20] * ((-d[1099]) * dv_3262 + (89.0 * M * d[7]) * Dx -
                   89.0 * dv_3260 - dv_3261);
  DataVector& dv_527 = temps.at(482);
  sc_23 +=
      d[77] * (d[1307] * dv_45 + d[2057] * dv_3247 +
               d[403] * (Dx * dv_3265 + dv_123 * xpddot + dv_527 * xpddot) +
               dv_3264) +
      dv_3258 * ((-d[2052]) * dv_1 - dv_2363);
  sc_23 += -dv_3259 * ((2.0 * yp) * ((39.0 * d[36]) + d[2055] * dv_240) +
                       (-d[388]) - 102.0 * dv_1229) +
           sc_13;
  sc_25 = d[362] * sc_23;
  ...
  sc_28 = (-d[273]) * ((-d[1344]) * dv_3595 + (d[9] * ypddot) * dv_258 +
  ...
  sc_28 += d[1153] * (-dv_3302 + dv_3317) +
           d[276] * ((-d[2198]) * dv_3594 + (M * ypddot) * dv_3595 +
  ...
  sc_14 = (d[1902] + d[2310]) * dv_3577 +
          (-d[1669]) * (Dx * (M * dv_2754 + d[1406] + d[2316] * dv_1631) +
                        dv_3271 - dv_3543);
  ...
  sc_14 +=
      d[1549] *
      ((-d[1240]) * dv_671 +
       Dx * ((-1139.0 * d[255]) + M * (dv_3584 + 47.0) - dv_2853 - dv_3585) +
       110.0 * dv_3308);
  ...
  sc_18 = (d[1048] + d[1593] + 3.0) * dv_2778 +
          (-d[1669]) * (M * (3.0 - dv_2358) + d[1406] + d[2316] * dv_69);
  DataVector& dv_2776 = temps.at(2329);
  DataVector& dv_2830 = temps.at(2382);
  DataVector& dv_3561 = temps.at(3034);
  sc_18 +=
      d[308] * ((4.0 * M) * (dv_2830 + 25.0) + (120.0 * d[2289] * ypdot) * Dy +
                (-2267.0 * d[255]) - dv_2776) +
  ...
  sc_28 =
      ...
      (-d[355]) * ((-d[1345]) * dv_3459 +
                   d[36] * ((-xpddot) * dv_679 + dv_2170 * dv_2754 + dv_3270) +
  ...
  sc_28 += d[604] * ((-d[88]) * (dv_281 * xpddot + dv_3553) +
  ...
  sc_14 = (-d[142]) * dv_833 + (d[2273] * d[535]) * dv_45 +
          d[1746] * (dv_2443 + dv_2680 * xpdot) +
          d[648] * (Dy * dv_2552 + dv_3562 * ypddot) +
          dv_3189 * ((247.0 * d[648]) + dv_3096 - dv_3115) + dv_3564;
  DataVector& dv_2753 = temps.at(2306);
  sc_14 +=
      ypdot *
      ((d[1140] * xpdot + d[1240]) * dv_14 +
       (-245.0 * d[1240] + 12.0 * xpdot * (-d[2162] + d[286] + 20.0)) * dv_15 +
       dv_2443 * ((-d[1269]) - dv_2753));
  sc_6 = (-d[308]) * sc_14;
  DataVector& dv_3144 = temps.at(2633);
  sc_18 =
      (2.0 * d[142]) * dv_3321 - 985.0 * dv_3144 +
      xpdot *
          ((d[1048] + d[1813]) * dv_14 +
           Dy * ((256.0 * rpdot + 53.0) * dv_240 + d[1980] - 2453.0 * dv_794));
  ...
  sc_12 += (4.0 * d[151] * yp) * Dy *
           (dv_3096 - dv_3221 + xpdot * (d[2276] * dv_1631 + dv_3100));
  sc_28 = (-d[1872]) * sc_12;
  DataVector& dv_2639 = temps.at(2215);
  sc_14 = (24.0 * d[3]) * dv_2759 +
          d[1053] * (-dv_2639 + ypdot * ((-ypdot) * dv_527 - dv_3422));
  DataVector& dv_2820 = temps.at(2372);
  DataVector& dv_2822 = temps.at(2374);
  DataVector& dv_3560 = temps.at(3033);
  sc_14 += -dv_0 * (M * dv_3560 + d[27] * (d[31] * dv_2822 + dv_3561)) -
           dv_2443 * dv_2820;
  sc_12 = (-d[1931]) * sc_14;
  ...
  sc_6 = d[1493] *
             (Dy * ((-yp) * (d[2282] + dv_2503) + (72.0 * d[319]) + dv_2781) +
              32.0 * dv_3486) +
         sc_18;
  ...
  sc_29 = (d[1035] * yp) * (d[396] * ((-d[2278]) * dv_14 + dv_3537) +
                            d[416] * dv_740 + d[563] * dv_3568) +
          dv_3451 *
              ((2.0 * yp) * (d[1495] + dv_2589) + (-d[239] * ypdot) - dv_2272) +
          sc_13 + sc_18 + sc_23;
  sc_6 = d[1466] * sc_29;
  ...
  sc_18 =
      M *
      (d[253] * (Dy * dv_2816 + dv_115 * ypddot) + d[255] * dv_3477 +
       yp * (d[1242] * dv_3477 + d[147] * dv_450 + 240.0 * dv_2868 + dv_3527));
  ...
  sc_13 += dv_3065 * (dv_2825 + dv_3563 +
                      yp * ((-d[1140]) * Dy + (247.0 * d[36]) + dv_2647)) +
  ...
  sc_9 += d[780] * ((-d[31]) * (dv_3582 + dv_3583) - dv_3290 - dv_3569) +
          dv_2804 * (M * (dv_2390 - dv_2848) + d[167] + d[2295] * dv_1881);
  ...
  sc_15 = d[1209] * dv_3586 + d[230] * (d[2280] * dv_3587 + dv_240 * dv_2841) +
          d[276] * ((75.0 * ypdot) * dv_3587 + (10.0 * M * ypddot) * dv_3589 -
  ...
  sc_18 += d[1107] * dv_1 * (M * (dv_2857 + dv_2858) + d[153] + dv_2418);
  sc_17 = M * sc_18;
  ...
  sc_15 +=
      ...
      d[724] * ((-ypdot) * (187.0 * dv_14 + 730.0 * dv_15) + 12.0 * dv_833);
  sc_18 = d[1053] * sc_15;
