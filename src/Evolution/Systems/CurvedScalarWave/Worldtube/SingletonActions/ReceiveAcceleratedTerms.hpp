 ...
 *                                     Frame::Grid>`
 */
struct ReceiveAcceleratedTerms {
  static constexpr size_t Dim = 3;
  using tags_list = tmpl::list<CurvedScalarWave::Tags::Psi,
                               ::Tags::dt<CurvedScalarWave::Tags::Psi>>;
  using inbox_tags = tmpl::list<::CurvedScalarWave::Worldtube::Tags::
                                    SphericalHarmonicsAcceleratedInbox<Dim>>;
  ...
  static Parallel::iterable_action_return_t apply(
    ...
    auto& inbox =
        tuples::get<Tags::SphericalHarmonicsAcceleratedInbox<Dim>>(inboxes);
