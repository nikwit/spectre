...
void puncture_field_2_part_7(const std::array<double, order2_n_doubles>& d,
  ...
  sc_9 = d[1523] +
         d[20] * ((-201.0 * d[255]) + M * (80.0 * dv_1502 + dv_2502 + 8.0) -
                  dv_2501) +
  ...
  sc_25 =
      (d[1521] + d[1522] * d[48] + d[259] * (28.0 * d[1242] - 157.0 * ypdot)) *
          dv_2115 +
  ...
  sc_23 = (-d[62]) * dv_2446 +
          (-xpdot) *
              (Dx * d[1510] + yp * (39.0 * dv_2375 + 80.0 * dv_2376 + dv_2423));
  DataVector& dv_1229 = temps.at(1124);
  DataVector& dv_2227 = temps.at(1829);
  DataVector& dv_2488 = temps.at(2076);
  sc_23 += d[3] * (M * (-39.0 * dv_1502 - dv_2488 - 8.0) + d[1509] + dv_2227) +
           d[6] * ((-d[62]) - 313.0 * dv_1229 + yp * (84.0 * Dy + d[1437]));
  ...
  sc_17 = (-d[1443]) * ((-M) * (dv_2536 + dv_2537 + 21.0) + (93.0 * d[255]) +
                        dv_2534 + dv_2535) +
  ...
  sc_17 += d[50] * ((-d[1539]) + M * (72.0 * dv_1502 + dv_2531) - dv_2530) +
           d[724] * ((-d[31]) * (dv_2510 + dv_2533) + (d[147] * d[512]) -
  ...
  sc_9 = (d[1247] + d[147] + d[504]) * dv_2524 +
         (-174.0 * d[1339] + d[1443] * (49.0 * d[7] + 26.0) + d[1537] +
          d[273] * (14.0 * d[1242] - 241.0 * ypdot)) *
             dv_2528 +
         (d[1533] * d[1534]) * dv_2463 +
         d[1135] * ((120.0 * ypdot) * Dx - 72.0 * dv_2375 - dv_2496) +
  ...
  sc_21 += d[1550] * ((89.0 * d[255]) + M * (-dv_2551 + dv_2552) +
                      140.0 * dv_2246 + dv_2534) +
           d[57] * (M * (-39.0 * dv_1503 - dv_2549 - 8.0) + d[1455] + dv_2227);
  sc_17 = sc_21 * xpdot;
  ...
  sc_28 = (-d[1527]) * (85.0 * dv_2376 + dv_2495 - dv_2544) +
          d[276] * ((-d[294]) * dv_1803 + (-xpddot) * dv_2541 +
                    (84.0 * ypdot) * Dx) +
  ...
  sc_28 = (-d[1443]) * (85.0 * dv_2375 + dv_2521 - dv_2522 - 102.0 * dv_751) +
          (M * d[20]) * ((d[1531] - 595.0 * d[7] + 40.0) * Dx + dv_2520) -
          170.0 * dv_2517;
  DataVector& dv_2452 = temps.at(2041);
  DataVector& dv_2518 = temps.at(2106);
  sc_28 += d[50] * ((156.0 * ypdot) * Dx - dv_2452 - dv_2518);
  sc_17 = sc_28 * xpdot;
  ...
  sc_21 = (-d[339]) * dv_2446 + (d[1520] * d[290]) * dv_2349 + d[1515] * dv_1 +
          d[1527] * (M * (dv_2157 - dv_2506) + dv_2507);
  DataVector& dv_2503 = temps.at(2091);
  DataVector& dv_2505 = temps.at(2093);
  sc_21 += d[276] * ((-M) * (72.0 * dv_1503 + dv_2505) + d[1525] + dv_2503);
  ...
  sc_21 +=
      d[724] * (M * (dv_2114 + dv_2431) + d[255] * dv_2511 - dv_2509 + dv_582) +
      sc_17;
  sc_15 = d[55] * sc_21;
  ...
  sc_17 =
      (-d[1532]) * dv_2446 + (-d[1533]) * dv_2554 +
      (-d[1553]) * (dv_2247 - dv_2556 + dv_2557) +
      d[1135] * ((-M) * (80.0 * dv_1503 + dv_2504 + 8.0) + d[1552] + dv_2555) +
      dv_2553;
  ...
  sc_17 += d[1536] * (M * (dv_2359 + dv_2477) + d[255] * dv_2561 + dv_1667 -
                      50.0 * dv_2246) +
           d[1554] * ((-M) * (dv_2559 + dv_2560) + d[153] + dv_2558);
  DataVector& dv_1685 = temps.at(1517);
  DataVector& dv_2562 = temps.at(2150);
  sc_17 += d[35] *
           ((-d[273]) * (d[1088] + 595.0 * dv_1 + dv_2513) +
            (-d[313]) * (d[88] + dv_2562) +
            (3.0 * d[50]) * ((67.0 * d[36]) + dv_1685) +
            (2.0 * d[48] * yp) * ((93.0 * d[36]) + 78.0 * Dy + 196.0 * dv_794) +
            (-d[780]));
  sc_17 += sc_28;
  sc_21 = d[63] * sc_17;
  ...
  sc_27 = (-3.0 * d[362]) *
              (d[1507] * dv_1805 + xpdot * (d[1376] + dv_1632 + dv_2482)) +
          sc_25 + sc_26;
  ...
  sc_25 = (-d[1172]) * ((198.0 * d[255]) + M * (-dv_2407 - dv_2797) + dv_2752) +
  ...
  sc_25 += d[230] * ((2.0 * M) * (50.0 * dv_1503 + dv_2796 + 9.0) + (-d[1664]) -
                     dv_2795) +
           d[384] * dv_2741;
  sc_23 = sc_25 * xpdot;
  ...
  sc_23 =
      (-d[1665]) *
          ((-M) * (dv_2731 + dv_2799 + 9.0) + (67.0 * d[255]) + dv_2775) +
      (30.0 * d[1651]) * dv_2798 +
  ...
  sc_23 += d[1649] * dv_2446 +
           d[1666] *
               (M * (192.0 * dv_1502 + dv_2369 + 25.0) + d[1403] - 22.0 * dv_1);
  DataVector& dv_1555 = temps.at(1429);
  DataVector& dv_2801 = temps.at(2354);
  sc_23 +=
      d[1669] * ((8.0 * M * xpddot) * Dx - 75.0 * dv_1 - dv_1555 - dv_2801);
  ...
  sc_23 +=
      xpdot *
      ((561.0 * d[7] - 125.0) * dv_2804 + (M * (118.0 * d[7] - 9.0)) * dv_2803 +
  ...
  sc_17 = (128.0 * d[384]) * dv_751 +
          ...
          d[1672] * ((29.0 * M * ypddot) * Dx - dv_2497 - dv_2812) +
          d[1674] * dv_2811;
  ...
  sc_25 = (-d[1549]) *
          ...
          (-d[1665]) * ((-M) * (68.0 * dv_1503 + dv_2805 + 3.0) +
                        (34.0 * d[255]) + dv_2250);
  ...
  sc_25 += d[1666] * (M * (87.0 * dv_1502 + dv_2806) + d[1671] + 165.0 * dv_1);
  ...
  sc_29 = (-d[1172]) * (d[1648] - 87.0 * dv_2331 + dv_2783) +
          (-d[223]) * ((17.0 * d[255]) + M * (-dv_2461 - dv_2470) + dv_1683) +
          (M * d[1333]) * (d[1284] + dv_2457 + 94.0 * dv_794) +
          (d[1645] * ypdot);
  ...
  sc_30 += d[1472] * (dv_2375 - dv_2399 + dv_2438 + dv_2781 * xpddot) +
  ...
  sc_29 =
      (-d[1191]) * (M * (dv_2765 + dv_2766 + 3.0) + d[255] - dv_1683) +
      (-d[1625]) * (d[266] * dv_1112 + yp * (-dv_1720 + dv_2383 + dv_2393)) +
      (-d[416]) * dv_2446;
  DataVector& dv_2434 = temps.at(2024);
  DataVector& dv_2763 = temps.at(2316);
  DataVector& dv_2764 = temps.at(2317);
  sc_29 += (2.0 * M) * dv_2434 +
           (3.0 * d[6]) * (d[524] + dv_2763 + yp * ((34.0 * d[36]) + dv_2764));
  sc_17 = d[1466] * sc_29;
  ...
  sc_28 += (d[6] * yp) * (d[104] * (d[1636] + dv_1637) + d[1633] +
  ...
  sc_30 += (-xpdot) * ((-d[348]) * ((-d[1]) * (68.0 * dv_1502 + dv_2701 + 3.0) +
                                    (98.0 * d[255]) + 153.0 * dv_1) +
                       (24.0 * M * yp) * (d[1631] + dv_2769 - dv_558) +
                       (-d[1630]) - dv_2768);
  ...
  sc_30 += (d[1627] * (-d[1318] - d[1582])) * dv_231 +
           ...
           d[1628] * ((27.0 * ypdot) * Dx - 124.0 * dv_2375 - dv_2767);
  ...
  sc_26 = (d[1343] * (d[1065] * d[382] + d[244] * (d[1391] + d[1394]))) * dv_6 +
          (d[491] * d[80]) * dv_1509 + (d[491] * ypddot) * dv_871 +
  ...
  sc_26 += d[488] *
           ((-d[52]) * dv_2208 + (22.0 * d[53]) * ((-d[1385]) - dv_1514) +
            d[1390] + d[50] * ((21.0 * yp * ypdot) - 22.0 * dv_0 - dv_2209));
  sc_17 = sc_26 * xpdot;
  ...
  sc_11 =
      (d[129] * (d[102] * ypddot + d[1191] * d[1242] - 60.0 * d[1241] +
                 d[1269] * (-d[1318] - d[303]) + d[147] * d[46] + d[155] * yp +
                 d[37] - d[431] * ypddot) +
       d[191] * (20.0 * M * d[20] * ypdot +
                 6.0 * M * d[280] * xpddot * xpdot * yp - d[1161] * d[1303] -
                 d[1297] * d[1341] - 27.0 * d[1339] - d[1340] * d[147] -
                 150.0 * d[1342] + 36.0 * d[50] * d[7] + 6.0 * d[57] * ypddot -
                 d[6] * (d[1335] + 39.0 * d[1339] + 228.0 * d[274])) +
       d[299] * (d[1312] * xpddot + d[1317] * xpdot) +
       d[50] * (d[1327] * d[280] + d[1329] * d[1330] +
                xpdot * (d[1317] * d[50] + d[1324] * d[49] * yp - d[1331] +
                         d[631] * (4.0 - 141.0 * d[7]))) +
       d[55] * (d[1196] * d[1320] - 300.0 * d[289] +
                xpdot * (-d[1322] * (d[1321] - 5.0) + 2.0 * d[1324] * d[48] -
                         d[1326] * d[348])) -
       d[61] * (6.0 * d[1241] * d[292] - d[1303] * d[1348] + 9.0 * d[1339] +
                ...
                d[780] * ypddot + d[866] * ypddot) -
       d[63] * (d[1056] * d[1336] +
                d[1200] * (d[1107] * (d[1193] + d[1338]) + d[1215] * d[313] +
                           d[1326] * d[50] + d[631] * (d[1337] - 8.0)) +
                d[142] * d[292] * d[510])) *
          dv_965 +
      (d[1205] * d[55] + d[50] * (d[1206] + d[1207] * xpdot + d[142]) +
       d[52] * (-8.0 * d[1208] + ypdot * (d[1034] + d[1209])) +
       d[53] * (d[1211] - ypdot * (d[1212] + d[155] + 13.0 * d[6] + 9.0)) -
       d[63] * (d[1213] + d[256] * xpddot + xpdot * (d[1212] + d[1215]))) *
          dv_968 +
      (-d[85]) * dv_2103 + (-d[85]) * dv_2105 + (-d[86]) * dv_2103 +
      (-d[86]) * dv_2105 + (-d[960]) * dv_2096 + (-d[961]) * dv_2096 +
      (-d[1205] * d[299] -
       d[122] * (-20.0 * d[1208] + 2.0 * d[1281] * ypddot + d[147] -
                 d[535] * ypdot) -
       d[50] * (d[1056] * d[1289] + d[1286] +
                xpdot * (M * yp * (d[1291] - 22.0 * ypdot) - d[1290] - d[244] +
                         d[50] * ypddot)) +
       ...
       d[53] * (-d[1031] * d[1300] - d[116] * d[1242] - d[1245] * d[48] -
                d[1269] * (d[430] * ypdot + d[436] + d[900] * ypdot) +
                2.0 * d[1285] * xpddot * xpdot * yp - d[1301] * d[48] -
                50.0 * d[1302] - d[1303] * d[162] - d[180] * d[88]) -
       d[55] * (d[1283] * xpddot -
                xpdot * (-d[110] * ypddot + d[1284] + 33.0 * d[180] +
                         50.0 * d[35] + d[471] * ypddot)) +
       d[63] * (d[1056] * d[1296] + 9.0 * d[142] * d[468] +
                xpdot * (d[110] * d[1215] + 19.0 * d[1297] + d[1298] * d[7] +
  ...
  DataVector& dv_978 = temps.at(841);
  DataVector& dv_982 = temps.at(810);
  sc_11 +=
      (d[121] * (d[1056] * d[498] +
       ...
       d[20] * (d[1250] * (d[1249] * (d[1269] + d[1271] + 9.0) +
                ...
                d[1268] * d[29]) -
       d[206] *
           (36.0 * M * d[20] * xpddot * xpdot - d[162] * d[7] +
            4.0 * d[20] * ypdot * (-d[1272] + 53.0 * ypdot) -
            d[286] * (d[138] + 165.0 * d[159] - 74.0 * d[20]) -
            d[396] * (d[1193] + d[1246] + d[1257]) + 53.0 * d[50] * ypddot) -
       d[55] * (d[1132] * xpddot + d[1250] * d[1259]) -
       d[61] * (-36.0 * d[1241] + d[1242] * d[1262] + d[1260] + d[1261] * yp +
                d[147] * d[42] + d[286] * (-51.0 * d[36] - d[493]) +
                d[497] * ypddot + d[72] * ypddot)) *
          dv_963 +
      ...
      (d[12] *
       (d[19] * (d[1056] * d[561] +
        ...
        d[20] * (d[1232] * d[557] +
                 xpdot * (d[1233] + d[1234] + d[396] * (d[1235] + d[6]))) +
        d[206] * (d[1030] * d[1254] + d[1251] * ypddot + d[1253] -
                  d[1256] * (d[1193] + d[1255]) +
                  d[286] * (-d[266] * d[3] + d[560]) +
                  d[77] * (10.0 * d[1242] + d[1245] - d[1257])) +
        d[226] * (d[1229] + d[1231] * xpdot) +
        d[52] * (d[1236] + d[1237] + d[1238] + d[1239] * yp - 24.0 * d[1241] +
                 d[1242] * d[1243] + d[1244] * (d[135] + d[36]) +
                 d[416] * ypddot))) *
          dv_982 +
  ...
  sc_11 +=
      (-d[1219] * d[336]) * dv_2104 + (-d[1219] * d[476]) * dv_2102 +
      (-d[1355] * d[208]) * dv_1899 + (-256.0 * d[1224] * d[206]) * dv_2104 +
      (32.0 * d[1203] * d[1216]) * dv_2100 + (M * d[1306] * d[330]) * dv_1887 +
      (d[1134] * d[336] * d[528]) * dv_1737 +
      (d[1352] * d[236] * rpdot) * dv_1902 +
  ...
  sc_11 += d[74] * (d[1210] * ((-xpdot) * dv_2121 + dv_2120) + dv_2139 +
                    xp * ((-d[81]) * dv_2117 - 6.0 * dv_2113 + dv_2116 +
                          xpddot * (d[1269] * dv_1880 + dv_1885 + dv_2119)));
  ...
  sc_22 += dv_1564 * ((15.0 * ypdot) * Dy + (-d[1734] - d[1823]) - dv_2483);
  sc_24 = (-d[19]) * sc_22;
  sc_22 = d[1222];
  ...
  sc_22 *= (-xp) * (dv_1 * dv_2155 - dv_3097 + dv_596 + dv_611 * xpdot) +
           (-ypdot) * (-dv_3095 + yp * (dv_603 + dv_610)) + d[170] * dv_1478 +
           d[6] * dv_2151;
  ...
  sc_16 +=
      d[1250] * (Dx * ((-d[20]) * (d[1962] * dv_2250 + dv_2685) +
                       (-d[259]) * ((213.0 * rpdot - 2.0) * dv_558 + dv_2689) +
  ...
  sc_16 +=
      d[6] * ((-d[348]) * dv_2678 + (-d[51]) * dv_2677 + (-d[77]) * dv_2683 +
              (9.0 * rpdot) * dv_2285 + d[48] * dv_2681);
  ...
  sc_16 += d[77] * ((-d[1806] * ypdot) * (dv_3012 + dv_725) +
                    d[1460] * dv_2220 + d[147] * dv_843 + dv_123 * ypdot +
  ...
  sc_19 =
      (-d[6]) * (-Dy * (Dy * d[1957] + d[303]) + dv_2638) +
      dv_0 * ((-M) * (41.0 * dv_1503 + 8.0) + (d[1502] - d[1958]) - dv_3200) +
      dv_2640;
  ...
  sc_6 +=
      ...
      d[273] * ((d[1930] * ypdot) * dv_723 + dv_2652 - 549.0 * dv_3148);
  ...
  sc_6 += d[35] * ((-d[77]) * dv_2658 + (M * d[1192]) * dv_2325 + dv_2660) +
          d[57] * ((-ypddot) * dv_2649 + dv_2647);
  sc_19 = sc_6 * yp;
  ...
  sc_22 +=
      (-xp) *
          ((d[135] * rpdot) * (d[1961] * dv_1631 * dv_231 + d[248] * dv_3203 +
                               d[289] * dv_672 + dv_742 * xpdot) +
           dv_2676) +
      d[122] * ((-xpddot) * dv_2636 + (2.0 * xpdot) * dv_2634) + sc_16 + sc_24;
  sc_22 += sc_19;
  sc_20 = (-d[331]) * sc_22;
  ...
  sc_18 += d[273] * ((-d[1556] + 591.0 * d[7] + 156.0 * rpdot) * dv_14 +
  ...
  sc_24 = (d[1140] + d[1209]) * dv_3358 +
          (-d[276]) * (dv_3425 - dv_729 * ((-M) * (dv_2487 + 3.0) +
  ...
  sc_24 +=
      d[1443] * (d[2157] * dv_3428 + d[36] * ((-xpddot) * dv_3429 + dv_3430) +
                 dv_3426 + dv_3427);
  ...
  sc_24 += d[1534] * ((-d[354]) * (Dy * (d[1519] + dv_972) + dv_352) +
                      Dy * d[471] + d[1] * (dv_454 * ypdot + dv_833));
  ...
  sc_13 += d[276] * (dv_3412 + dv_729 * (M + d[1967] * dv_1881 + dv_2671));
  ...
  sc_12 += d[308] * ((-d[2168] + 252.0 * rpdot + 16.0) * dv_14 -
  ...
  sc_12 = d[101] * (Dx * ((2.0 * d[2185] * ypdot) * Dy + (-d[1500]) +
  ...
  sc_12 += d[50] * (Dx * ((-d[1539]) + M * dv_2531 + d[2183] * dv_2250) +
  ...
  sc_12 += dv_2350 * ((d[1140] + d[1817]) * dv_2354 + (-d[1443]) * dv_3417 +
           ...
           dv_2831 * ((-d[1513]) * dv_1502 + (24.0 * rpdot * yp * ypdot) * Dy);
  sc_13 = (-d[57]) * sc_12;
  ...
  sc_10 *= (-d[101]) * ((-d[2172]) * dv_240 + (191.0 * d[36]) + dv_3447) +
           ...
           d[724] * ((-M) * dv_3448 + (28.0 * d[255]) + dv_2751) + d[780];
  ...
  sc_8 +=
      d[1550] * ((111.0 * rpdot - 16.0) * dv_2334 - 191.0 * dv_2293 +
  ...
  sc_18 +=
      d[1542] * (-Dy * ((-d[248]) * dv_2794 + (M * yp) * (d[46] + dv_2519) +
                        (-d[2173]) - dv_2603) +
                 d[1533] * dv_691) +
      sc_10 + sc_14;
  ...
  sc_2 = (-d[321]) * (dv_3422 + dv_589 * ypdot) +
  ...
  sc_14 +=
      (-d[436]) * (d[1242] * dv_1731 + d[1375] * dv_635 + dv_2651 + dv_3421 +
                   ypdot * ((d[1998] + 4.0) * dv_15 + d[2152] * dv_14)) +
      sc_10;
  ...
  sc_8 +=
      ...
      ((-d[1076]) * (d[2149] * dv_14 - dv_1039) + (-d[36]) * dv_3413 +
       (-yp) * (Dy * d[1968] - dv_2261 * (dv_2891 + 1.0) + dv_3414 + dv_3415) +
       dv_2966);
  sc_8 += (-d[9]) * Dx * (d[2147] * dv_1 + dv_2486) +
          (2.0 * d[6]) * Dx *
              (d[62] + 176.0 * dv_1229 + yp * ((-d[2148]) + d[1967] * dv_605));
  sc_14 = d[362] * sc_8;
  DataVector& dv_3467 = temps.at(2942);
  sc_28 = (-d[120]) * dv_2438 +
          (-d[1549]) * ((-d[37]) * (Dx * dv_3448 + dv_3441) +
                        (-3.0 * d[2159]) * dv_45 + 423.0 * dv_3247 + dv_3460) +
          d[59] * (Dx * ((81.0 * M * d[7]) - dv_3423) + dv_3467);
  ...
  sc_26 = (-d[1409]) * (d[2148] + d[2188] * dv_538) +
          (-d[1443]) *
              ((13.0 - 61.0 * rpdot) * dv_558 + (177.0 * d[36]) + dv_3464) +
  ...
  sc_10 += (8.0 * d[151] * yp) * (d[1106] * (dv_14 + dv_609) -
                                  dv_1762 * dv_2402 + dv_2880 + dv_3462) +
           (12.0 * rpdot * yp) * (d[101] * (d[2186] * dv_14 + d[2187] * dv_15) +
  ...
  sc_6 += -dv_2444 * ((-d[2347]) * dv_1685 + (-d[2348]) * dv_794 + d[2123]) +
          dv_2771 * ((-d[1655]) + M * (dv_2406 + dv_2791 + 25.0) - dv_3625) +
          dv_2788 * dv_2850;
  sc_13 = (-d[1570]) * sc_6;
  ...
  sc_13 *= (92.0 * d[1543] + d[1642] + d[230] * d[2323] - d[466] +
           ...
           Dy * ((-d[1672]) * (d[1889] + dv_3454) +
                 d[1536] * ((d[1280] + 199.0) * dv_1552 + (131.0 * M)) +
                 d[1647] * (d[1] + dv_2562) +
  ...
  sc_16 += d[996] *
           ((-d[1291]) * (dv_2975 + dv_724) + Dy * d[2350] + dv_1762 * dv_2861 +
            ypdot * (d[2344] * dv_15 + d[2345] * dv_14));
  sc_13 = d[1250] * sc_16;
  ...
  sc_10 += d[308] * ((268.0 * M) + d[2348] * dv_1552);
  sc_16 = -dv_2115 * sc_10;
  ...
  sc_24 +=
      d[1172] *
          ((-d[36]) * (192.0 * dv_1583 + dv_2170 * dv_2806 + dv_774 * xpddot) +
  ...
  sc_24 +=
      d[1549] *
          ((-d[2347]) * Dx * dv_2250 + (2.0 * M * xpddot) * (dv_2920 + dv_683) +
           (214.0 * M * d[7]) * Dx - 214.0 * dv_3260 - 1449.0 * dv_3287) +
  ...
  sc_10 =
      (-d[1672]) * ((-d[1242]) * dv_565 + d[255] * dv_3348 +
                    ypdot * ((-d[2160]) * dv_14 + d[2331] * dv_15)) +
  ...
  sc_28 =
      d[1710] * ((-d[1240]) * dv_343 +
                 Dx * ((-M) * dv_3291 + d[167] + d[1832] * dv_2481) + dv_3271) +
      d[384] * dv_3529;
  ...
  sc_28 += d[104] * dv_5 * ((-ypdot) * (-dv_2018 - dv_2779) + Dx * d[1842]);
  sc_10 = sc_28 * yp;
  DataVector& dv_2944 = temps.at(2474);
  DataVector& dv_3314 = temps.at(2801);
  sc_16 = (6.0 * M * d[142] * yp) * (d[116] * (dv_14 + dv_3314) + dv_2944) +
          sc_10 + sc_13;
  sc_16 += -dv_2115 *
