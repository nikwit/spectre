...
void puncture_field_generic_0(
  ...
  const double d_12 = d_0 * (d_11 - 1) + d_1 * d_5 + d_1 * d_8 + d_6 * d_7;
  ...
  dv_25 = d_15 * dv_22 + d_16 * dv_24 - 6 * dv_18;
  ...
  dv_29 = d_15 * dv_27 + d_16 * dv_28 - 4 * dv_18;
  ...
  dv_45 =
      d_32 *
          (-d_13 * d_33 * dv_9 +
           d_13 * dv_8 * rp * (d_0 * dv_42 + d_3 * dv_43 + dv_43 * rp + dv_44) +
           d_31 * dv_9 * (-M * d_35 * d_38 - d_41) * 1.0 / (d_12 * d_12) +
           d_34 * dv_11 - dv_2 * dv_7) +
      dv_40 * xpdot + dv_41 * ypdot;
  DataVector& dv_46 = temps.at(2);
  dv_46 = d_44 * dv_36 * 1.0 / dv_37;
  ...
  dv_50 = -d_15 * dv_49 + 3 * dv_3 * yp + dv_48;
  ...
  dv_55 = 2 * dv_50 * ypdot +
          2 * xpdot * (dv_52 - dv_53 * (d_29 + dv_51) + xp * (dv_22 + dv_54)) -
          2 * ypdot * (-dv_24 * yp + dv_3 * dv_51);
  ...
  get(get<CurvedScalarWave::Tags::Psi>(*result)) =
      (1.0 / 2.0) *
      (4 * M * dv_12 - d_18 * dv_25 * dv_26 + d_20 * dv_32 - 2 * dv_10 + dv_17 +
       dv_21) /
      pow(dv_16, 3.0 / 2.0);
  get(get<::Tags::dt<CurvedScalarWave::Tags::Psi>>(*result)) =
      -dv_59 * 1.0 / d_21 * 1.0 / d_23 *
      (-2 * d_21 * d_23 * dv_37 * dv_45 - 7 * d_26 * dv_36 * dv_38 +
       d_43 * dv_45 * dv_46 +
       dv_38 * (d_23 * d_25 * d_39 * dv_25 * dv_5 - d_26 * dv_31 +
                ...
                2 * dv_31 * pow(rp, 5.0 / 2.0) * (M * d_35 * d_38 + d_41) *
                    1.0 / d_24));
  get<0>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      (dv_38 *
           (-d_28 * dv_30 - dv_62 * dv_63 - dv_64 * xp +
            2 * dv_8 * (d_19 * (dv_52 + dv_58 * xp - dv_61) + d_3 * dv_62)) +
  ...
  get<1>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      -dv_65 * (dv_38 * (-d_30 * dv_30 - dv_50 * dv_63 - dv_64 * yp +
                         2 * dv_8 * (d_19 * dv_57 + d_3 * dv_50)) +
                dv_41 * dv_46 + dv_41 * dv_60);
  get<2>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
                           Frame::Inertial>>(*result)) =
      (1.0 / 2.0) * d_20 * z *
      (4 * M * dv_16 * (d_15 + d_16) * (-dv_34 + dv_8 * (d_3 + rp)) -
       d_44 * dv_35 - d_46 * dv_16 - 3 * dv_32) /
      pow(dv_16, 5.0 / 2.0);
}
}  // namespace CurvedScalarWave::Worldtube
