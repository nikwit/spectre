...
void puncture_field_2_part_11(const std::array<double, order2_n_doubles>& d,
  ...
  sc_14 = (-d[1581]) * dv_2469 +
          (-d[1834]) * ((-d[1818] - d[1875] + 13.0 * d[20] * d[2923]) * Dy +
                        d[1470] * dv_0 + dv_3907) +
          (d[2622] * d[361]) * dv_752;
  ...
  sc_14 += d[2623] * ((-d[2921]) * (dv_3904 + dv_3905) + d[648] * dv_2227);
  ...
  sc_14 += d[342] * ((d[1254] * (d[2267] + 25.0 * d[6]) - d[2270]) * dv_2170 +
                     (d[2625] * d[2922]) * Dy) +
           d[343] * ((36.0 * d[2928] * d[20] * d[2626] - d[2627]) * Dy +
  ...
  sc_15 += (-d[128]) *
           (d[101] * ((-d[2633]) * dv_2170 + (221.0 * d[2922] * d[2923]) * Dy) +
  ...
  sc_15 += (-d[299]) * ((-d[1421] - d[1426]) * dv_3909 + d[248] * dv_780 +
                        d[2630] * dv_752) +
           (-4.0 * d[1466]) * dv_265 + (d[120] * d[2099] * d[2922]) * Dy +
  ...
  sc_4 += (-d[2577]) *
              (d[2920] * (d[2576] * dv_0 + dv_1552 + dv_3846) +
               d[2921] * ((3.0 * d[2922]) * Dy + (3.0 * d[7] * d[2922]) * Dy -
                          dv_1530 - dv_3131)) +
  ...
  sc_4 += (d[427] * d[475] * d[852]) * dv_3860 + d[124] * dv_3845 +
          d[171] * (dv_3848 * d[2921] + dv_3849 * d[2920]) +
  ...
  sc_28 = (-d[306]) * dv_289 + (-d[2231] - d[2702]) * dv_3182 +
          (-d[1244] * d[1374]) * dv_1 + (12.0 * d[147] * d[92] * d[2921]) * Dx +
          d[2922] * ((-4.0 * d[2586]) * dv_4 + (d[1766] * d[2585]) * Dx +
                     Dy * d[1120] + d[1118] * dv_627);
  DataVector& dv_119 = temps.at(117);
  DataVector& dv_2803 = temps.at(2356);
  DataVector& dv_726 = temps.at(675);
  sc_28 += d[2923] *
           (d[1121] * dv_119 + d[164] * dv_726 + d[795] * dv_119 - dv_2803);
  sc_30 = (-d[168]) * sc_28;
  sc_28 = (-d[237]);
  ...
  sc_6 = d[153] * ((-d[133]) * Dx + Dx * d[112] + dv_34 * d[2920]) +
         dv_3853 * d[2920] +
         d[2922] * ((-d[2702]) * dv_5 + (d[2580] * d[2920]) * Dx +
                    (2.0 * d[2928] * d[137]) * Dy - 10.0 * dv_146);
  DataVector& dv_851 = temps.at(790);
  sc_6 += d[2923] * ((-d[1367]) * dv_119 + (-d[697] - d[72]) * dv_726 +
  ...
  sc_33 += (-d[563]) *
               ((-d[194]) * dv_119 + (-d[195]) * dv_876 + (22.0 * d[122]) * Dy +
                (66.0 * d[55] * d[2921]) * Dx - 46.0 * dv_875 - dv_902) +
           (-d[232] * d[273]) * Dx + (-d[2928] * d[1292]) * dv_876 +
           (-d[1] * d[188]) * dv_386;
  ...
  sc_14 +=
      ...
      (-d[197] * (d[383] + d[48] * (d[102] + d[238])) +
       ...
       d[2703] * d[781] -
       d[76] * d[2920] * (d[383] + d[48] * (d[480] + d[541])) -
       d[2922] *
           (d[2928] * (2.0 * d[19] * d[20] * d[548] + 13.0 * d[20] * d[55] -
                       d[300] - 21.0 * d[340] - d[48] * d[59]) +
            d[3] * (d[48] * (d[2705] + d[545] + 57.0 * d[57]) + d[489]))) *
          dv_977 +
      (-d[2709] *
       (-d[425] * (d[144] + d[424]) +
        d[2920] * (d[436] * (d[410] + d[706]) - d[440] * (d[116] + d[437]) +
                   d[2923] * (d[441] + d[91] * (-d[177] - d[2704] - d[2708]))) -
        d[2922] * (d[2706] + d[287] * (-d[2707] + 33.0 * d[55] - d[59]) +
      ...
      (-d[2716] *
       (d[189] * (-d[1443] * (d[338] + d[60] + d[729]) - d[427] * d[446] +
                  32.0 * d[459] * d[591]) +
        d[2920] *
            (-d[125] * d[2665] + d[2662] * d[299] * d[2923] +
        ...
        d[2922] *
          ...
          dv_6 +
      (4.0 * d[48] * d[71]) * dv_3877 +
      (4.0 * d[384] * d[420] * d[2920]) * dv_1908 +
      (8.0 * d[151] * d[390] * d[2920]) * dv_1907 +
      (16.0 * d[375] * d[43] * d[2920]) * dv_1906 +
      (4.0 * d[384] * d[420] * d[2921] *
       (-d[397] * (d[145] * d[994] + d[382] * (d[144] + d[394])) +
        d[2920] * (d[411] * (d[410] + 100.0 * d[603]) -
                   d[415] * (d[382] * (d[116] + d[413]) - d[412] * d[994]) +
                   d[2923] * (d[1104] * (d[2719] + d[2720] + d[57]) +
                              d[2717] * d[373] + d[417])) +
        d[2922] *
            (-d[403] * (d[382] * (d[400] + d[458] + d[729]) + d[399] * d[994]) +
             d[2921] * (-d[2717] * d[353] + d[405] +
                        d[95] * (d[2718] - d[408] + d[57]))))) *
          dv_6 +
      (8.0 * d[151] * d[390] * d[2921] *
  ...
  sc_14 +=
      (16.0 * d[375] * d[43] * d[2921] *
       (d[189] * (12.0 * d[19] * d[352] * d[2923] - d[2721] * d[353] -
                  d[439] * (-d[199] + 124.0 * d[55] - d[57])) +
        d[2920] *
            (d[1127] * d[121] * d[2722] +
             d[387] *
                 (d[373] * d[994] + d[92] * (-d[225] + 13.0 * d[55] - d[841])) -
             d[439] * (d[121] * (d[72] + d[796]) + d[230] - 53.0 * d[55])) +
        d[2922] * (d[121] * d[312] * d[365] + d[155] * d[352] * d[63] +
                   d[36] * (-245.0 * d[1466] + d[1618] -
                            d[20] * d[234] * (d[1954] + d[91]) +
                            d[2098] * (-252.0 * d[20] + d[48]) +
                            d[227] * d[57] * (d[2696] + d[48]))))) *
          dv_6 +
      (16.0 * d[130] * d[19] * d[375] * d[92] * d[2921]) * dv_1912 +
      (384.0 * d[20] * d[4] * d[52] * d[538] * d[551]) * dv_6 +
      (16.0 * d[130] * d[375] * d[92] * d[2920] * d[2921] *
       (-d[101] * d[541] * d[92] + d[1130] * d[121] * d[180] +
        d[121] * d[35] * d[479] +
        d[1382] * (-d[1348] * d[485] * d[2921] - d[2206] * d[50] * d[92] +
                   d[491] * d[2923]) -
        d[484] * (d[481] * d[994] + d[92] * (d[483] + d[57])))) *
          dv_6 +
      (32.0 * d[1133] * d[19] * d[382] * d[40] * d[475] * d[2921]) * dv_6 +
      (128.0 * d[0] * d[1129] * d[19] * d[382] * d[475] * d[2921]) * dv_6;
  ...
  sc_5 += (6.0 * d[1060] * d[130] * d[16]) * dv_224 * dv_3957 -
          dv_3844 * ((3.0 * d[2928] * d[12]) * dv_1867 * dv_3817 - dv_3839 -
                     dv_3841 * dv_3842) -
  ...
  sc_5 += (6.0 * d[0] * d[1060]) * dv_11 * dv_229 * dv_4012 +
          ...
          (4.0 * d[2928] * d[16] * d[74]) * dv_229 * dv_3817 * dv_3820 +
          (8.0 * d[2928] * d[16] * d[74]) * dv_1867 * dv_229 * dv_3813 +
          (12.0 * d[2928] * d[75]) * dv_11 * dv_19 * dv_3817 * dv_3820 + sc_4;
  sc_5 +=
      (24.0 * d[2928] * d[75]) * dv_11 * dv_1604 * dv_1867 * dv_3820 +
      (24.0 * d[2928] * d[75]) * dv_11 * dv_1867 * dv_19 * dv_3813 +
      (36.0 * d[130] * d[16]) * dv_10 * dv_1604 * dv_229 * dv_3957 +
      (16.0 * d[2928] * d[16] * d[74]) * dv_1604 * dv_1867 * dv_19 * dv_3820 +
      (24.0 * d[2928] * d[1060] * d[75]) * dv_10 * dv_1867 * dv_19 * dv_3820;
  DataVector& dv_1611 = temps.at(1461);
  DataVector& sc_0 = temps.at(3222);
  sc_0 = ((1.0 / 48.0) * d[2928] * d[1024] * d[1025]) * dv_1611 * sc_5;
  ...
  sc_3 = ((1.0 / 2.0) * d[2928] * d[23]) *
             ((-d[1060]) * dv_3773 + dv_3778 + dv_43 * d[2920]) +
         ((7.0 / 48.0) * d[2928] * d[1024] * d[1025]) * dv_1604 * dv_225 *
             dv_3771 -
  ...
  sc_21 +=
      d[54] *
      ((-d[50]) * dv_4087 + d[53] * ((d[2922] * d[2921]) * dv_3808 - dv_4088) +
       d[63] * (-dv_2181 + d[2921] * (-dv_4089 + dv_4090 * d[2923])) + dv_4084 +
       dv_4086);
  ...
  sc_4 = (d[1062] * d[5] + d[68] * d[77] + d[2923]) * dv_1597 +
         (-d[17]) * dv_4093 + dv_4094 + sc_11;
  sc_5 = (2.0 * d[2926]) * sc_4;
  ...
  sc_1 = (9.0 * d[2928]) * dv_1607 * dv_1611 * dv_1616 - dv_1606 * dv_3784 -
         dv_1607 * dv_3785 -
  ...
  DataVector& dv_2009 = temps.at(164);
  ...
  sc_33 += (d[120] * d[2926]) * Dx * (d[578] * dv_185 + d[9] * dv_2045) -
  ...
  sc_14 = (-d[2921]) * dv_3970 + d[1063] * dv_3963 + dv_3962 * dv_4104 +
  ...
  sc_6 *= d[116] * (d[1] * dv_751 - 5.0 * dv_119) +
          d[2920] * (Dy * d[697] + d[37] * dv_4 - dv_2385) +
          d[2921] * ((-d[2920]) * dv_2168 + d[849] * dv_3296);
  DataVector& dv_4114 = temps.at(1596);
  DataVector& dv_4115 = temps.at(956);
  sc_13 = d[1803] * dv_4114 + sc_6 + d[2923] * (d[2582] * dv_4 + dv_4115);
  sc_14 = (-d[2583]) * sc_13;
  ...
  sc_6 += d[20] * ((d[2928] * d[20] - d[1393] - d[313] +
                    11.0 * d[48] * d[2921] * d[2923]) *
                       dv_728 +
  ...
  sc_30 += d[2920] * (d[20] * (d[2824] * dv_751 - dv_4122) + d[91] * dv_4121 +
                      dv_4120) +
           d[2921] * ((d[138] + d[158] * d[20] - d[213]) * dv_0 +
  ...
  sc_30 *= (-d[59]) *
               ((44.0 * d[2928] * d[2921] - 120.0 * d[252] - d[448] * d[2923]) *
                    dv_1237 +
                d[2836] * dv_1531) +
  ...
  sc_12 =
      ...
      d[123] * ((-d[1161] - d[2615] + 324.0 * d[48] * d[2921] * d[2923] +
                 16.0 * d[50] * d[2923]) *
                    dv_0 +
  ...
  sc_36 =
      (d[1466] * d[20]) *
          ((4.0 * d[1681] * d[2921] - 497.0 * d[36]) * dv_0 +
  ...
  sc_36 += d[2004] * ((-d[1704] + 36.0 * d[2921] * d[2923]) * dv_3941 +
  ...
  sc_34 += d[1581] * (d[396] * (Dx * d[503] + dv_3913) + dv_1827 + dv_3944) +
           d[1845] * ((-198.0 * d[1543] + d[1551] + d[1641] + 524.0 * d[604] -
                       1392.0 * d[992]) *
                          dv_0 +
                      (-d[393] + d[91]) * dv_3942 +
                      (-220.0 * d[1182] + d[1641] * d[2923] -
                       d[2292] * d[2293] - d[2697]) *
                          dv_240);
  ...
  sc_7 += d[1905] * ((-d[20]) * (dv_2851 + 146.0 * dv_752) +
                     ...
                     d[91] * ((10.0 * d[2922]) * Dy - dv_2812)) +
          d[2622] * dv_2761;
  sc_7 +=
      d[2623] * ((-d[2921]) * dv_2469 + d[2050] * dv_0) +
      d[341] *
  ...
  sc_7 +=
      d[342] * ((-d[2269]) * dv_1531 + d[2625] * dv_0 + 600.0 * dv_3884) +
      d[343] * ((36.0 * d[2928] * d[20] * (d[2241] + d[2626]) - d[2627]) * Dx +
  ...
  sc_15 += (-d[299]) * (d[248] * dv_1115 + d[2630] * dv_0 + d[2843] * dv_4136) +
           ...
           (d[120] * d[2099] * d[2922]) * Dx +
           (4.0 * d[2928] * d[361] * d[2923]) * Dy;
  ...
  sc_21 = (-d[2594] * d[527]) * dv_4127 +
          (d[476] * d[839] * d[2920]) * dv_3860 + d[128] * dv_3845 - dv_4113 -
          dv_4116 + sc_13 + sc_14 + sc_33 + sc_6;
  DataVector& dv_4111 = temps.at(1615);
  DataVector& dv_4112 = temps.at(133);
  sc_21 += d[171] * (dv_4112 + d[2922] * (d[1122] * dv_231 - dv_4111)) + sc_30;
  ...
  sc_21 += d[2577] * ((-d[2821]) * dv_4109 + (-d[2922]) * dv_4110 + dv_4106 -
                      dv_4108) +
  ...
  sc_17 = (-d[2826]) * dv_34 + (d[2825] * d[62]) * dv_1115 + d[1120] * dv_0 +
          d[19] * ((d[1118] * d[2922] * d[2921]) * Dx - dv_4119) +
          d[52] * ((-d[2822]) * dv_751 + d[2823] * dv_4117);
  sc_17 += d[2920] * ((-d[91]) * dv_4121 +
                      d[20] * ((-d[2824]) * dv_751 + dv_4122) - dv_4120);
  sc_34 = (-d[168]) * sc_17;
  ...
  sc_36 *= (d[631] * (-d[1578] * d[50] + d[1776] + d[194] * d[2923])) * dv_0 +
           ...
           dv_4141;
  sc_7 = (-d[1225]) * dv_4127 +
         (-d[171]) * (-dv_4112 + d[2922] * (d[170] * dv_231 + dv_4111)) -
         dv_4113 - dv_4116 + sc_34;
  sc_7 += (-d[237]) *
          (d[122] * dv_4128 + d[50] * ((d[214] * d[2922]) * Dx - dv_4131) +
           d[55] * dv_4129 + d[61] * dv_4133 + dv_4134 + dv_4135);
  sc_7 +=
      (-d[2577]) * (d[2821] * dv_4109 - dv_4106 + dv_4108 + dv_4110 * d[2922]);
  ...
  sc_7 +=
      ...
      (-d[180] * d[19] * (d[383] + d[48] * (-d[112] - d[919])) -
       d[2] * (d[259] * (-d[1550] + 8.0 * d[19] * d[329] - d[429] - d[925]) +
               d[2923] * (d[48] * (d[2705] + d[546] + 57.0 * d[55]) + d[489])) +
      ...
      (-d[443] *
       (-d[425] * (d[121] + d[423]) +
        d[2920] *
            (d[436] * (d[371] + d[410]) - d[440] * (-d[19] + 26.0 * d[20]) +
             d[2923] * (d[441] + d[91] * (d[2707] - d[442] + d[56]))) -
        d[2922] * (d[2706] + d[287] * (d[172] + d[2708] - d[429]) +
                   d[435] * (d[19] * d[430] + d[223] + d[56] + d[866])))) *
          dv_289 +
      (-d[467] *
       (d[357] * (32.0 * d[2928] * d[382] * d[2921] * d[2923] - d[447] -
                  d[49] * (d[20] * d[437] + d[229] + d[521])) +
        d[2920] * (d[180] * (d[453] + d[49] * (-d[339] - d[60] - d[685])) +
                   d[37] * (d[198] * d[48] + d[2852] + 17.0 * d[340] +
                            d[348] * d[55] + d[547] * d[60]) +
                   d[449] * (-d[112] + d[448])) +
        d[2922] *
            (d[1606] * d[382] * d[50] +
             d[321] * (-d[2852] - 305.0 * d[341] - d[455] - d[456] * d[55]) +
  ...
  sc_7 +=
      (4.0 * d[48] * d[71]) *
          (d[55] *
               ((-d[2603]) * dv_0 + (2.0 * d[2928] * d[2830]) * Dy - dv_4137) +
           dv_4140) +
      (4.0 * d[384] * d[420] * d[2921]) * dv_1908 +
      (8.0 * d[151] * d[390] * d[2921]) * dv_1907 +
      (16.0 * d[375] * d[43] * d[2921]) * dv_1906 +
      (4.0 * d[384] * d[420] * d[2920] *
       (-d[397] * (d[145] * d[996] + d[382] * (d[121] + d[393])) +
        d[2920] * (d[411] * (d[410] + 100.0 * d[604]) +
                   d[415] * (d[382] * (d[19] - d[414]) + d[412] * d[996]) +
                   d[2923] * (d[370] * d[418] + d[417] +
                              d[95] * (d[2718] - d[419] + d[55]))) +
        d[2922] * (d[104] * d[312] * (d[2720] + d[2787] + d[55]) -
                   d[115] * d[406] - d[1161] * d[319] * d[399] +
                   d[382] * d[403] * (-d[401] - d[458] - d[685]) +
                   d[405] * d[2921]))) *
          dv_6 +
      (8.0 * d[151] * d[390] * d[2920] *
       (d[1199] * (-d[1533] * d[638] + d[2847]) + d[126] * (d[2636] + d[2711]) +
        ...
        d[50] * d[648] *
            (d[271] - 39.0 * d[276] - 170.0 * d[277] +
             d[724] * (d[1544] + 5.0)))) *
          dv_6;
  sc_7 += (16.0 * d[375] * d[43] * d[2920] *
           (d[206] * (d[1128] * d[261] +
                      d[255] * (d[373] * d[996] + d[92] * (d[200] - d[374])) -
                      d[356] * (d[226] + d[363] - 53.0 * d[57] - d[835])) +
            d[357] *
                (-d[151] * d[243] * d[353] + 12.0 * d[352] * d[2921] * d[2923] -
            ...
            d[2922] *
                (d[1395] * d[352] +
                 ...
                 d[366] * d[51]))) *
              dv_6 +
          (16.0 * d[130] * d[20] * d[375] * d[92] * d[2920]) * dv_1912 +
          (384.0 * d[19] * d[4] * d[50] * d[538] * d[551]) * dv_6 +
          (16.0 * d[130] * d[375] * d[92] * d[2920] * d[2921] *
           (d[1130] * d[2851] * d[2920] + d[116] * d[189] * d[479] -
            d[1293] * d[2920] * (d[481] * d[49] + d[810] * d[92]) -
            d[2703] * d[542] +
            d[2922] * (-d[486] * d[62] - d[488] * (d[1471] + d[55]) +
                       2.0 * d[491] * d[2921] * d[2923]))) *
              dv_6 +
          (32.0 * d[1133] * d[20] * d[382] * d[40] * d[475] * d[2920]) * dv_6 +
          (128.0 * d[0] * d[1129] * d[20] * d[382] * d[475] * d[2920]) * dv_6;
  ...
  sc_5 += (6.0 * d[1063] * d[130] * d[16]) * dv_224 * dv_3957 -
          dv_3844 * ((3.0 * d[2928] * d[12]) * dv_1867 * dv_4096 -
                     dv_3842 * dv_4105 - dv_4103) -
  ...
  sc_5 += (6.0 * d[0] * d[1063]) * dv_11 * dv_229 * dv_4012 +
          ...
          (4.0 * d[2928] * d[16] * d[74]) * dv_229 * dv_3820 * dv_4096 +
          (8.0 * d[2928] * d[16] * d[74]) * dv_1867 * dv_229 * dv_4095 +
          (12.0 * d[2928] * d[75]) * dv_11 * dv_19 * dv_3820 * dv_4096 + sc_11 +
          sc_21;
  sc_5 +=
      (24.0 * d[2928] * d[75]) * dv_11 * dv_1607 * dv_1867 * dv_3820 +
      (24.0 * d[2928] * d[75]) * dv_11 * dv_1867 * dv_19 * dv_4095 +
      (36.0 * d[130] * d[16]) * dv_10 * dv_1607 * dv_229 * dv_3957 +
      (16.0 * d[2928] * d[16] * d[74]) * dv_1607 * dv_1867 * dv_19 * dv_3820 +
      (24.0 * d[2928] * d[1063] * d[75]) * dv_10 * dv_1867 * dv_19 * dv_3820;
  sc_1 = ((1.0 / 48.0) * d[2928] * d[1024] * d[1025]) * dv_1611 * sc_5;
  sc_3 = ((1.0 / 2.0) * d[2928] * d[23]) *
             ((-d[1063]) * dv_3773 + dv_4066 + dv_43 * d[2921]) +
         ((7.0 / 48.0) * d[2928] * d[1024] * d[1025]) * dv_1607 * dv_225 *
             dv_3771 -
  ...
  sc_11 *= d[356] * dv_1626 + d[65] * dv_6 + d[66] * dv_6 +
           d[93] * ((d[395] * d[2920]) * dv_790 + d[19] * (dv_1527 + dv_1984) +
                    d[20] * ((5.0 * d[2923]) * Dy - dv_0));
  ...
  sc_12 = d[19] *
          (d[29] * (-62.0 * dv_1717 + d[2923] * (dv_131 - dv_3497 + dv_708)) +
           d[9] * dv_2024);
  ...
  sc_12 += d[20] * (d[29] * (dv_2076 * d[2923] + dv_2917) + d[9] * dv_2031) +
           d[206] * ((-d[1578] - 93.0 * d[3]) * dv_801 +
                     (3.0 * d[2922] * d[2921]) * (dv_131 - dv_2006 + dv_703));
  DataVector& dv_3590 = temps.at(3063);
  sc_12 += d[2570] * (dv_2086 * d[2922] + dv_3590);
  sc_34 = (-d[12]) * sc_12;
  ...
  sc_28 =
      (-d[52]) * (dv_1835 + dv_2039 * d[2922]) +
      d[19] * (dv_2181 + d[2921] * (Dy * dv_2140 +
                                    d[2923] * (-dv_114 - dv_4159 - dv_679)));
  ...
  sc_28 += d[20] * ((-d[2921]) * (dv_1818 + dv_2062 * d[2923]) + dv_2965) +
  ...
  sc_11 = (-d[1096] * d[12]) * dv_4209 + (-4.0 * d[107]) * dv_1791 * dv_1863 +
          (d[2928] * d[0] * d[16]) * dv_1741 * dv_1797 +
          (2.0 * d[2928] * d[92]) * dv_1791 * dv_1797 * dv_4207 +
          (4.0 * d[2928] * d[2926]) * dv_1741 * dv_1791 * dv_4216 + sc_4;
  sc_21 = d[108] * sc_11;
  ...
  sc_5 =
      ...
      (d[2912] *
       (d[2428] * (d[19] * (d[2896] - d[80] * (d[135] * d[7] + d[2888])) +
                   d[20] * (d[2897] + d[2923] * (d[1473] - d[2898] * d[2921])) -
                   d[2894] * d[609] - d[2895]) +
        d[2882] * (d[2881] + d[2923] * (-d[2334] * d[2921] + d[314])) +
        d[2911] +
        d[43] * (-d[19] * (-d[2820] * d[284] + d[6] * (d[1361] + d[88])) -
                 d[2479] * d[508] +
                 d[2920] * d[2922] *
                     (d[2640] * d[280] - d[2923] * (d[1876] + d[2871])) +
                 d[2921] * (d[286] * (d[1358] + d[2872] + d[77]) -
                            d[7] * (d[1322] + d[2873]))) +
        d[465] * (-d[286] * d[98] + d[2874] * d[2920] * d[2922] -
                  d[2875] * d[2923]) +
        d[845] * (-d[19] * (d[2878] + d[2879] * d[7]) - d[2] * d[2880] +
                  d[2877] * d[52] * d[2922] -
                  d[2921] * (d[2879] * d[35] +
                             d[2923] * (d[162] + d[213] - d[430] * d[7]))) +
        d[873] * (-d[2899] * d[2900] + d[2903]) +
        d[899] *
            (-d[2883] * d[2884] + d[2885] * d[50] * d[2920] * d[2922] +
             d[2886] * d[52] * d[2922] * d[2921] - d[2892] * d[60] +
             d[55] * (-d[2887] * d[6] + 2.0 * d[2889] * d[2923]) -
             d[57] * (d[2890] + d[2923] * (d[1401] - d[2891] * d[2921]))))) *
          dv_1497 +
      (d[558] * d[83]) * dv_1789 +
      (6.0 * d[16] * d[75] *
       (d[2428] * (d[19] * (d[154] * d[88] - d[261] * d[2904] + d[2896]) +
        ...
        d[43] *
            (4.0 * d[2928] * d[412] * d[7] - 5.0 * d[1116] - d[1117] * d[2913] -
             d[391] + d[6] * (d[150] * d[1721] + d[2736] * d[9]) +
             d[2920] * d[2922] * d[2923] *
                 (-d[2871] + 10.0 * d[2923] * (d[19] + d[48]))) +
        d[465] * (d[1281] * d[286] + d[2] * d[2874] - d[2875] * d[2923]) +
        d[845] * (-d[19] * (-d[148] + d[1955] + d[2878] + d[9]) -
                  d[2] * d[2880] + d[2877] * d[609] +
                  d[2921] * (-d[1295] + d[20] * d[2923] * (d[1580] + d[6]) -
  ...
  sc_3 = (-d[183] * d[23]) * dv_4203 +
         ((7.0 / 48.0) * d[2928] * d[1024] * d[1025]) * dv_225 * dv_3771 -
         dv_3768 - dv_3769 + sc_0 + sc_1 - 1.0;
