...
void puncture_field_2_part_5(const std::array<double, order2_n_doubles>& d,
  ...
  dv_4062 += (-d[2043] * d[2781] * d[643]) * dv_1084 +
             ...
             (-d[231] * d[2761] * rp * xpdot) * dv_4023 + d[1155] * dv_4056 +
             d[1155] * dv_4059 + d[2446] * dv_4031;
  ...
  dv_4062 += (-d[580]) * dv_3472 * dv_5 + d[847] * dv_4050 + dv_1020 * xp +
  ...
  DataVector& dv_4063 = temps.at(988);
  DataVector& dv_613 = temps.at(564);
  dv_4063 = (-d[121]) * Dy + d[29] * dv_4 + dv_613;
  DataVector& dv_4064 = temps.at(3180);
  ...
  DataVector& dv_4067 = temps.at(1140);
  dv_4067 = d[1061] * dv_0;
  ...
  DataVector& dv_4070 = temps.at(1642);
  dv_4070 = d[631] * dv_1115;
  DataVector& dv_1531 = temps.at(1408);
  DataVector& dv_263 = temps.at(256);
  DataVector& dv_4071 = temps.at(1661);
  dv_4071 = d[1216] * (dv_1531 + dv_263 - dv_4068);
  DataVector& dv_4072 = temps.at(387);
  dv_4072 = (d[1] * d[2819] + d[282] * rp) * dv_854;
  DataVector& dv_3912 = temps.at(3189);
  DataVector& dv_4073 = temps.at(1168);
  ...
  DataVector& dv_4080 = temps.at(1197);
  dv_4080 = dv_240 * dv_4;
  ...
  DataVector& dv_4091 = temps.at(116);
  dv_4091 = -dv_1706;
  ...
  sc_5 = d[2571] * ((-d[1622] - d[9]) * dv_801 + (xpdot * yp) * dv_1688) +
         d[2590] * (dv_1679 * xpdot + dv_4085) +
         d[51] * (-dv_2965 + yp * (dv_1713 + dv_1717));
  DataVector& dv_1981 = temps.at(149);
  DataVector& dv_3373 = temps.at(2855);
  DataVector& dv_527 = temps.at(482);
  sc_5 += d[55] * (dv_3373 + dv_4091 * ypdot) +
          d[63] * ((-M) * dv_527 + (-yp) * dv_1981);
  ...
  DataVector& dv_4100 = temps.at(387);
  dv_4100 = dv_4 * yp;
  ...
  sc_7 = (4.0 * d[2574]) * dv_490 +
         d[19] * ((-d[20]) * (dv_0 * dv_3469 + dv_1826 * ypdot) +
  ...
  sc_7 += d[20] * ((-d[20]) * (dv_1833 * ypdot - dv_241) + d[104] * dv_1830 +
                   d[77] * (dv_114 + dv_3353));
  DataVector& dv_163 = temps.at(161);
  DataVector& dv_3225 = temps.at(2712);
  DataVector& dv_731 = temps.at(680);
  sc_7 += d[28] * (d[1] * dv_3225 + xpdot * ((d[144] + d[91]) * dv_163 +
                                             d[468] * dv_14 + dv_731)) +
          d[55] * (-dv_1818 + dv_4091 * ypdot);
  sc_5 = (2.0 * M * d[12]) * sc_7;
  ...
  dv_4101 = (-d[651]) * dv_3824 +
            (-d[2647] * yp - ypdot * (d[1] + d[1045])) * dv_3823 +
            (-yp) * dv_3834 + (2.0 * d[22] * ypdot) * dv_1586 +
            (4.0 * d[48] * d[92] * rp * yp) * dv_253 - dv_1810 * dv_4063 + sc_5;
  DataVector& dv_1815 = temps.at(1601);
  dv_4101 += -dv_1815 * ((d[37] + yp) * dv_5 + Dy * d[227] +
                         xp * ((-d[29]) * Dx + (4.0 * M * xpdot) * Dy));
  ...
  dv_4101 += -dv_3833 *
             (d[1] * ((d[104] + d[20]) * Dy + dv_4100) +
              xpdot * ((d[48] + d[897]) * dv_231 + d[348] * dv_119 + dv_898) +
              ypdot * ((d[348] + d[49]) * dv_5 + (-d[112]) * dv_5 + dv_271));
  DataVector& dv_2 = temps.at(2);
  DataVector& dv_6 = temps.at(6);
  dv_4101 += (4.0 * d[22]) * dv_2 * dv_4064 +
             (4.0 * d[48] * d[92] * rp) * dv_6 * (Dx * d[87] + d[90] * dv_240);
  ...
  dv_4104 += d[54] * (d[50] * dv_4087 + d[53] * ((-d[86]) * dv_3808 + dv_4088) +
                      d[63] * (dv_2181 + yp * ((-ypdot) * dv_4090 + dv_4089)) -
                      dv_4084 - dv_4086);
  ...
  dv_4126 = (M + 19.0 * d[3]) * dv_833 + (-d[245]) * dv_3567 + d[254] * dv_0;
  ...
  dv_4129 = (M + d[1932]) * dv_1709 + (-60.0 * M * d[6]) * Dy + d[211] * dv_0;
  ...
  DataVector& dv_4132 = temps.at(149);
  ...
  dv_4135 =
      d[182] * ((d[1298] * ypdot + d[1511] * (d[1276] - 1.0) + d[563]) * Dy +
  ...
  dv_4140 =
      d[122] * ((-d[2831]) * dv_3910 + (d[267] * ypdot) * Dx +
                (-d[1123] * d[2640]) * Dx) +
  ...
  dv_4140 += d[57] * ((-d[88] + 19.0 * yp * ypdot) * dv_1762 + d[2602] * dv_0) +
             d[63] * ((d[2671] - 180.0 * d[277] + d[2834] * d[99]) * dv_0 +
                      (d[2833] + d[364]) * dv_3896 +
                      (d[1] * (d[1668] + d[2551])) * dv_5);
  DataVector& dv_4141 = temps.at(1350);
  dv_4141 = d[1199] * ((M * d[20] * (d[2145] + 163.0 * d[6]) - d[2146]) * Dx +
  ...
  dv_4141 +=
      ...
      d[337] *
          ((2.0 * M * d[20] * (d[2140] + 77.0 * d[6]) - d[2143]) * Dx +
  ...
  DataVector& dv_4145 = temps.at(1061);
  ...
  dv_4149 += d[127] * ((d[2107] + d[2118] * d[259] + d[350] * ypdot) * dv_240 +
                       (-d[1315] + 24.0 * yp * ypdot) * dv_3858 + dv_3374) +
             d[128] * ((d[2112] - d[2120] * d[259] + d[749]) * dv_240 +
                       (d[1628] + d[1637] + d[77]) * dv_4148 + dv_3375);
  dv_4149 +=
      d[299] * ((-M - d[1958]) * dv_3567 + d[1002] * dv_1 + d[2724] * dv_0);
  ...
  DataVector& dv_4197 = temps.at(3115);
  dv_4197 = (d[2865] * d[3]) * dv_1432;
  DataVector& dv_4008 = temps.at(1106);
  DataVector& dv_4198 = temps.at(1106);
  dv_4198 = d[151] * dv_4008;
  DataVector& dv_4199 = temps.at(1683);
  dv_4199 = d[2565] * dv_4185;
  DataVector& dv_4200 = temps.at(909);
  dv_4200 = d[2867] * dv_1432;
  DataVector& dv_4201 = temps.at(947);
  ...
  dv_4202 += (-d[2866]) * dv_4011 + (-d[319]) * dv_1051 + (-d[636]) * dv_557 +
             ...
             (-d[722]) * dv_4183 + (-d[765]) * dv_4177 + (-yp) * dv_1037 +
             (-yp) * dv_3988;
  ...
  dv_4202 += (-yp) * dv_3995 + (-64.0 * d[123]) * dv_4032 +
  ...
  dv_4202 += (d[132] * d[2855]) * dv_1465 + (d[157] * d[2400]) * dv_15 +
             ...
             (d[19] * d[633]) * dv_836 + (d[2] * ypdot) * dv_1044 +
  ...
  dv_4202 += (-d[2442] * d[2817]) * dv_4185 + (-d[2485] * d[598]) * dv_4200 +
             ...
             (-d[2719] * yp) * dv_4170 + (-d[2756] * d[652]) * dv_163 +
  ...
  dv_4202 += (d[1390] * d[2793] * d[370] * d[384]) * dv_4171 +
             (d[2760] * d[2815] * d[462] * xp) * dv_4006 +
  ...
  sc_5 += d[13] * ((-xpdot) *
                       ((-d[91]) * dv_3779 + (-d[121] * (d[144] + d[49])) * Dx +
                        dv_112 + dv_284) +
                   (-ypdot) * (d[116] * dv_854 - dv_1173 + dv_138 + dv_294) +
                   (4.0 * M * d[92]) * dv_6) +
          d[271] * dv_254;
  ...
  sc_4 = d[19] * ((d[1701] - d[1813] * yp) * Dy + (d[512] + d[556]) * dv_1630 +
                  dv_3896) +
         d[52] * ((d[1544] - d[2876] + 6.0) * Dx - dv_4213) +
         xp * ((d[104] + d[1612] + d[20] * (d[152] + d[531] + 6.0)) * Dx +
               (d[1622] + d[306]) * dv_3137);
  DataVector& dv_3916 = temps.at(1049);
  DataVector& dv_3941 = temps.at(3202);
  sc_4 += yp * ((d[104] - d[20] * (d[1580] - 6.0) + d[2559]) * Dy +
  ...
  sc_1 =
      (-d[19]) * ((-d[403] - yp * (d[1189] + 11.0)) * dv_240 + d[2916] * dv_5 +
                  196.0 * dv_1031) +
      (-d[206]) * ((-yp) * ((d[1248] - d[1728] + 22.0) * Dx - 196.0 * dv_265) +
                   d[1083] * dv_790);
  DataVector& dv_1696 = temps.at(1527);
  sc_1 += d[20] * ((d[2509] + d[46]) * dv_1696 +
                   (-d[314] + yp * (44.0 - d[1997])) * Dy + d[1909] * dv_5) +
  ...
  sc_2 += d[129] * ((-d[1593] + d[1868] - 11.0) * dv_2170 +
          ...
          d[205] * (Dx * d[1401] + d[1668] * dv_752 +
                    yp * ((d[1371] + d[2916] - 66.0) * Dx + dv_3922));
  sc_2 += d[337] *
              ((-yp) * ((d[1596] + d[1785] + 11.0) * dv_2170 - 173.0 * dv_265) +
  ...
  dv_4214 =
      (-d[2882]) * ((d[1801] * yp - d[314]) * Dy + d[2915] * dv_0 + dv_3931 +
                    xp * ((d[2646] + d[288] + 12.0) * Dx + dv_4213)) +
      (d[2908] * d[2909]) * dv_6 +
      (d[2907] * d[2910] * (d[1387] + d[557])) * dv_6 + sc_1 + sc_4 + sc_5 +
      sc_7;
  dv_4214 +=
      d[465] * ((d[2914] * yp - d[314]) * Dy + (-d[88]) * dv_0 +
                (xp * (d[286] + d[2914])) * Dx + (2.0 * d[6] * yp) * Dy) +
      sc_0 + sc_3;
  DataVector& dv_4215 = temps.at(3126);
  DataVector& dv_869 = temps.at(805);
  DataVector& dv_93 = temps.at(91);
  dv_4215 = d[2722] * ((-rp) * dv_854 + d[2918] * dv_4100 + d[2919] * dv_613) +
            d[2723] * ((-rp) * dv_869 + d[2918] * dv_3779 + d[2919] * dv_93) +
            d[2918] * dv_2107;
  ...
  sc_9 = d[119] * (d[118] * dv_395 + d[54] * dv_414 + dv_174 * dv_382) +
         xpdot * (d[100] * dv_321 + d[114] * dv_445 + d[118] * dv_475);
  DataVector& dv_477 = temps.at(445);
  DataVector& dv_500 = temps.at(201);
  DataVector& dv_523 = temps.at(415);
  sc_9 +=
      ypdot * ((-d[114]) * dv_500 + (-d[29]) * dv_477 + (3.0 * d[12]) * dv_523);
  ...
  sc_7 = M * dv_227 * dv_315 + d[111] * dv_228 + sc_5;
  sc_4 = (-d[108]) * sc_7;
  ...
  sc_5 += (-d[6] * d[658]) * dv_1419 + (-d[658] * d[999]) * dv_16 +
          ...
          (d[142] * d[579] * d[83] * xp) * dv_15 +
          (d[147] * d[579] * d[83] * yp) * dv_14 +
          (d[71] * d[944] * yp * ypdot) * dv_14 +
          (2.0 * M * d[236] * d[6] * d[714]) * dv_15 +
          (2.0 * M * d[236] * d[6] * d[714]) * dv_16 +
          (2.0 * d[108] * d[20] * d[48] * d[695]) * dv_15 +
          (8.0 * d[151] * d[43] * yp * ypdot) * dv_1215;
  sc_5 += (8.0 * d[151] * d[43] * xp * xpdot) * dv_1218 +
          (8.0 * d[151] * d[75] * xp * xpdot) * dv_16 +
          (8.0 * d[151] * d[75] * yp * ypdot) * dv_16 +
          (d[236] * d[6] * d[793] * yp * ypdot) * dv_16 +
          (d[236] * d[7] * d[803] * xp * xpdot) * dv_16 +
          (d[579] * d[6] * d[83] * yp * ypdot) * dv_15 +
          (d[579] * d[7] * d[83] * xp * xpdot) * dv_14 +
          (2.0 * M * d[108] * d[628] * d[7] * d[733]) * dv_14 +
          (4.0 * M * d[106] * d[6] * d[610] * d[626]) * dv_16 +
          (4.0 * M * d[106] * d[610] * d[628] * d[7]) * dv_16;
  sc_5 += (4.0 * M * d[594] * d[75] * xp * xpdot) * dv_16 +
          (4.0 * M * d[594] * d[75] * yp * ypdot) * dv_16 +
          ...
          (8.0 * d[142] * d[330] * d[48] * d[626] * xp) * dv_15 +
          (8.0 * d[142] * d[330] * d[48] * d[626] * xp) * dv_16 +
          (8.0 * d[147] * d[330] * d[48] * d[628] * yp) * dv_14 +
          (8.0 * d[147] * d[330] * d[48] * d[628] * yp) * dv_16;
  sc_5 += (M * d[207] * d[582] * d[733] * xp * xpdot) * dv_14 +
          (M * d[549] * d[632] * d[695] * yp * ypdot) * dv_15 +
          (2.0 * M * d[19] * d[50] * d[71] * d[969] * ypdot) * dv_14 +
          (2.0 * M * d[20] * d[52] * d[71] * d[969] * xpdot) * dv_15 +
          (2.0 * M * d[207] * d[582] * d[733] * yp * ypdot) * dv_14 +
          (8.0 * d[142] * d[20] * d[330] * d[48] * d[598] * xp) * dv_15 +
          (8.0 * d[147] * d[19] * d[330] * d[48] * d[598] * yp) * dv_14 +
          (8.0 * d[330] * d[48] * d[6] * d[626] * yp * ypdot) * dv_16 +
          (8.0 * d[330] * d[48] * d[6] * d[628] * yp * ypdot) * dv_15 +
          (8.0 * d[330] * d[48] * d[626] * d[7] * xp * xpdot) * dv_14;
  sc_5 += (8.0 * d[330] * d[48] * d[628] * d[7] * xp * xpdot) * dv_16 +
          (20.0 * M * d[131] * xp * xpdot * yp * ypdot) * dv_14 +
          (20.0 * M * d[131] * xp * xpdot * yp * ypdot) * dv_15 +
          (40.0 * M * d[131] * xp * xpdot * yp * ypdot) * dv_16 +
          (M * d[20] * d[549] * d[595] * d[695] * xp * xpdot) * dv_15 +
          (2.0 * M * d[19] * d[330] * d[582] * d[586] * yp * ypdot) * dv_14 +
          (2.0 * M * d[19] * d[586] * d[632] * d[71] * yp * ypdot) * dv_15 +
          (2.0 * M * d[20] * d[330] * d[582] * d[586] * xp * xpdot) * dv_15 +
          (2.0 * M * d[20] * d[586] * d[621] * d[71] * xp * xpdot) * dv_14 +
          (4.0 * M * d[19] * d[20] * d[236] * d[586] * d[598] * d[6]) * dv_15;
  sc_5 +=
      (4.0 * M * d[19] * d[20] * d[236] * d[586] * d[598] * d[7]) * dv_14 +
      (8.0 * d[19] * d[330] * d[48] * d[598] * d[6] * yp * ypdot) * dv_15 +
      (8.0 * d[20] * d[330] * d[48] * d[598] * d[7] * xp * xpdot) * dv_14 +
      (16.0 * d[106] * d[48] * d[582] * xp * xpdot * yp * ypdot) * dv_16 +
      (16.0 * d[19] * d[330] * d[48] * d[598] * d[6] * yp * ypdot) * dv_16 +
      (16.0 * d[20] * d[330] * d[48] * d[598] * d[7] * xp * xpdot) * dv_16 +
      (2.0 * M * d[108] * d[598] * d[733] * xp * xpdot * yp * ypdot) * dv_14 +
      (4.0 * M * d[236] * d[586] * d[626] * xp * xpdot * yp * ypdot) * dv_14 +
      (4.0 * M * d[236] * d[586] * d[628] * xp * xpdot * yp * ypdot) * dv_15 +
      (8.0 * M * d[106] * d[598] * d[610] * xp * xpdot * yp * ypdot) * dv_16;
  DataVector& dv_1169 = temps.at(1064);
  DataVector& dv_1174 = temps.at(1069);
  sc_5 += (8.0 * d[151] * d[22] * d[50] * xpdot) * dv_1169 * dv_1174 +
          (8.0 * d[151] * d[22] * d[52] * ypdot) * dv_1169 * dv_1174 +
          (M * d[621] * d[695] * xpdot * yp) * dv_1169 * dv_1174 +
          (2.0 * M * d[40] * d[703] * xpdot * ypdot) * dv_1169 * dv_1174 +
          (2.0 * d[48] * d[695] * rp * xp * yp) * dv_1169 * dv_1174 +
          (4.0 * d[40] * d[48] * d[50] * d[586] * xp) * dv_1169 * dv_1174 +
          (4.0 * d[40] * d[48] * d[52] * d[586] * yp) * dv_1169 * dv_1174;
  sc_5 += (8.0 * d[130] * d[48] * d[610] * xp * yp) * dv_1169 * dv_1174 +
          (24.0 * d[151] * d[19] * d[22] * xpdot * yp) * dv_1169 * dv_1174 +
          (24.0 * d[151] * d[20] * d[22] * xp * ypdot) * dv_1169 * dv_1174 +
          (M * d[12] * d[582] * d[695] * xp * ypdot) * dv_1169 * dv_1174 +
          (M * d[20] * d[595] * d[695] * xp * ypdot) * dv_1169 * dv_1174 +
          (2.0 * M * d[43] * d[582] * d[610] * xp * ypdot) * dv_1169 * dv_1174 +
          (2.0 * M * d[43] * d[582] * d[610] * xpdot * yp) * dv_1169 * dv_1174;
  sc_5 +=
      (2.0 * M * d[626] * d[695] * rp * xpdot * ypdot) * dv_1169 * dv_1174 +
      (4.0 * d[19] * d[40] * d[48] * d[621] * xpdot * ypdot) * dv_1169 *
          dv_1174 +
      (4.0 * d[20] * d[40] * d[48] * d[632] * xpdot * ypdot) * dv_1169 *
          dv_1174 +
      (4.0 * d[40] * d[48] * d[50] * d[595] * d[6] * xp) * dv_1169 * dv_1174 +
      (4.0 * d[40] * d[48] * d[52] * d[595] * d[7] * yp) * dv_1169 * dv_1174 +
      (4.0 * d[40] * d[48] * d[6] * d[621] * xp * yp) * dv_1169 * dv_1174 +
      (4.0 * d[40] * d[48] * d[632] * d[7] * xp * yp) * dv_1169 * dv_1174;
  sc_5 +=
      (2.0 * M * d[0] * d[19] * d[50] * d[586] * d[595] * xpdot) * dv_1169 *
          dv_1174 +
      (2.0 * M * d[0] * d[19] * d[586] * d[621] * xpdot * yp) * dv_1169 *
          dv_1174 +
      (2.0 * M * d[0] * d[20] * d[52] * d[586] * d[595] * ypdot) * dv_1169 *
          dv_1174 +
      (2.0 * M * d[0] * d[20] * d[586] * d[632] * xp * ypdot) * dv_1169 *
          dv_1174 +
      (2.0 * M * d[598] * d[695] * d[7] * rp * xp * yp) * dv_1169 * dv_1174 +
      (4.0 * M * d[22] * d[582] * d[6] * d[621] * xp * ypdot) * dv_1169 *
          dv_1174 +
      (4.0 * M * d[22] * d[582] * d[632] * d[7] * xpdot * yp) * dv_1169 *
          dv_1174;
  sc_5 += (8.0 * d[19] * d[20] * d[40] * d[48] * d[595] * xpdot * ypdot) *
              dv_1169 * dv_1174 +
          (4.0 * M * d[19] * d[22] * d[582] * d[595] * d[7] * xpdot * yp) *
              dv_1169 * dv_1174 +
          (4.0 * M * d[20] * d[22] * d[582] * d[595] * d[6] * xp * ypdot) *
              dv_1169 * dv_1174;
  ...
  sc_6 *=
      ...
      ypdot * (d[139] * ((-d[19]) * dv_31 + d[20] * dv_62 - dv_22) + dv_539);
  ...
  sc_8 =
      ...
      xpdot * ((-d[156]) * dv_536 + (-xp) * dv_570 +
               (86.0 * M * d[12] * ypdot - d[157] - d[158] * d[50]) * Dx * Dy +
               d[52] * dv_562);
  DataVector& dv_383 = temps.at(366);
  DataVector& dv_573 = temps.at(526);
  DataVector& dv_575 = temps.at(528);
  sc_8 += ypdot * ((-d[161]) * dv_383 + (-d[58]) * dv_573 + (-yp) * dv_575 +
                   (25.0 * d[20] * xp) * Dx * Dy);
  sc_9 = d[168] * sc_8;
  ...
  sc_10 += ypdot * ((-d[120]) * dv_690 + (-d[218]) * dv_161 +
  ...
  sc_10 *= d[313] * ((-d[19]) * dv_446 + d[20] * dv_644) + dv_845 +
           xpdot * ((-d[55]) * dv_815 + d[52] * dv_814 + dv_825) +
  ...
  sc_12 = (-xp) * dv_548 +
          d[6] * ((-d[3]) * dv_547 + (6.0 * xp * ypdot) * Dx * Dy - dv_549) +
  ...
  DataVector& dv_806 = temps.at(731);
  ...
  sc_2 = (d[34] * (d[523] * (-d[19] * d[522] - d[521]) + d[525]) + d[517] +
          xpdot * (-d[36] * d[520] + 4.0 * d[518] * d[92] * yp)) *
             dv_965 +
         (-d[205] * d[537] - d[337] * d[533] - d[530] + d[55] * xpdot * ypdot +
          d[57] * xpdot * ypdot) *
             dv_968 +
         (-d[260]) * dv_743 + (-d[301]) * dv_806 +
         (-d[469] * d[6] * xp * yp + d[472] * xpdot +
          xp * (-d[180] * d[473] + d[474])) *
             dv_951 +
  ...
  sc_2 += d[171] *
          ((-ypdot) * dv_604 + (-xpdot) * (-dv_607 + dv_611 * xp) +
           (8.0 * M * d[7]) * dv_16 + d[6] * dv_606 - dv_593 - dv_597 - dv_599);
  ...
  sc_2 +=
      d[208] * dv_667 +
      d[351] * ((-d[189]) * dv_861 + (-xpdot) * dv_872 +
                (2.0 * M * d[92]) * dv_846 + (d[142] * d[174] * d[52]) * dv_16 +
  ...
  sc_2 += dv_948 * ((-d[357]) * dv_940 +
                    xp * ((-d[180]) * dv_944 +
                          d[31] * (d[92] * dv_943 + dv_942) + d[449] * dv_941) +
  ...
  sc_2 += -dv_961 * ((-d[478]) * dv_953 + (-xpdot) * dv_959 +
                     (2.0 * d[479] * d[6] * xp * yp) * dv_6 - dv_952 - dv_956);
  ...
  sc_1 += (-d[109]) * dv_227 * (d[47] * pow(dv_227, 2.0) + dv_315) +
          (4.0 * M * d[16] * d[74]) * dv_227 * dv_229 * dv_248 +
          (12.0 * M * d[75]) * dv_11 * dv_19 * dv_227 * dv_248 + sc_5;
  ...
  sc_1 += (8.0 * M * d[16] * d[74]) * dv_10 * dv_229 * dv_44 *
          ((-d[13]) * dv_74 + dv_237 - dv_72 + rp * (dv_239 + dv_67));
  ...
  sc_7 = (-d[166] * d[67]) * dv_1624 + (-d[1067] * d[166] * d[39]) * dv_1589 +
         ...
         d[1068] * dv_1597 * dv_180 + dv_1623 + dv_1665 * rp;
  ...
  sc_7 += d[1071] * dv_1596 *
          ((-d[1069]) * dv_1605 + (-M * d[1028] * d[1070]) * dv_1626 +
  ...
  sc_7 += d[1071] * dv_180 *
          (-dv_1739 + xpdot * ((6.0 * d[48] * xp) * dv_12 * dv_1666 - dv_1704));
  sc_5 = rp * sc_7;
  ...
  sc_1 = (-d[510]) * dv_1622 *
             ((-d[17]) * dv_1619 + (-d[1064] * d[39]) * dv_1613 +
              d[1035] * dv_1612 - dv_1507 * dv_1621 + dv_1614 * rpdot +
  ...
  sc_1 += (2.0 * d[12]) * dv_1602 * dv_20 *
              ((-d[1028]) * dv_1500 + (-d[18]) * dv_1537 +
               (2.0 * M * d[5]) * dv_1509 * dv_6 +
               (3.0 * d[1028] * d[17] * rpdot) * dv_11 - dv_1501 - dv_2) +
  ...
  sc_6 = (-d[55]) * (dv_1564 * (dv_2060 * yp + dv_479 * dv_624) +
  ...
  sc_6 += d[1198] * (dv_751 * ((-yp) * dv_2068 + 4.0 * dv_484) +
  ...
  sc_6 +=
      d[57] * ((-ypdot) * (dv_14 * (dv_2064 + dv_993) + 45.0 * dv_202 +
  ...
  sc_13 = (-d[1198]) * ((-xpdot) * (-dv_14 * (93.0 * dv_5 + dv_520) -
  ...
  sc_14 += d[52] * (dv_751 * (-Dy * dv_405 + dv_2025 * yp) +
  ...
  sc_14 += d[53] * ((-xpdot) * (-dv_14 * (dv_411 + 33.0 * dv_5) - dv_1659 +
                                dv_412 + 17.0 * dv_989) +
  ...
  sc_12 += (-d[63]) * (dv_1564 * ((-yp) * dv_2021 + 6.0 * dv_1643) +
  ...
  sc_17 += d[1199] * (-dv_0 * ((-yp) * dv_2093 + 4.0 * dv_2087) +
  ...
  sc_17 += d[55] * (dv_1530 * (-dv_2087 + dv_2088 * yp) +
  ...
  sc_17 += d[57] * (-dv_1530 * ((-yp) * dv_1598 - dv_2044 * dv_447) +
                    xpdot * (d[27] * dv_988 - dv_1011 -
  ...
  sc_15 = d[1073] * dv_1857 + d[34] * dv_1985 + dv_1736 * dv_476 * xp +
          dv_477 * xpdot + sc_16;
  sc_12 = d[1200] * sc_15;
  ...
  sc_16 = (-d[129]) * (Dy * dv_2039 * ypdot - dv_0 * dv_2037) + sc_17;
  ...
  sc_16 += (-d[57]) * ((-xpdot) * (-dv_1061 + dv_14 * (-dv_435 - dv_94) +
                                   dv_2032 + dv_437) +
  ...
  sc_16 += d[55] * (dv_1530 * (-dv_2040 + dv_2041 * yp) +
  ...
  sc_16 *= (-d[19]) * (dv_1553 + dv_1984) +
           (-xp) * (-dv_1513 * dv_2018 + xpdot * (dv_379 + dv_541)) +
           yp * ((-ypdot) * (dv_1698 + dv_381) + dv_0 * (d[29] + dv_728));
  ...
  sc_8 = (d[1103] * d[88]) * dv_1854 + (d[1192] * d[12]) * dv_1853 +
         (d[94] * rpdot) * dv_1855 + (-d[1070] * d[955]) * dv_523 +
         (-d[118] * ypddot) * dv_523 + d[1068] * dv_1852 + d[1188] * dv_477 +
  ...
  sc_8 += d[1191] * dv_1985 + d[1194] * dv_500 + d[1195] * dv_500 +
          d[1196] * (dv_1858 + dv_477 * xp) + dv_1510 * dv_1851 * dv_2017 +
