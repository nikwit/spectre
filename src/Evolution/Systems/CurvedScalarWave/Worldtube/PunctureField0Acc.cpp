...
void puncture_field_acc_0(
  ...
  const double d_23 = (1.0 / 2.0) * d_15 * 1.0 / d_22;
  ...
  const double d_33 =
      -M * (-2 * d_11 - 2 * d_12 - 2 * d_29 - 2 * d_30 + rpdot) * 1.0 / d_7 -
  ...
  dv_38 = -d_26 * (2 * M * dv_2 * dv_6 * rp + 3 * d_15 * dv_10 * rpdot -
                   ...
                   d_20 * d_33 * dv_10 * 1.0 / (d_14 * d_14) - d_28 * dv_3) +
  ...
  get(get<CurvedScalarWave::Tags::Psi>(*result)) = -d_23 * dv_27 * 1.0 / dv_12;
      ...
      (-3 * d_25 * d_42 * dv_27 * dv_38 * dv_39 +
       d_25 * d_42 * dv_29 *
           (4 * M * d_14 * d_20 * dv_2 * dv_38 * ft +
            ...
            2 * d_0 * d_14 * dv_17 * dv_38 * fy - d_20 * dv_24 * dv_7 * ftdot -
            dv_10 * dv_40 - dv_10 * dv_43 - dv_10 * dv_8 * ftdot -
       ...
       2 * d_33 * dv_27 * dv_29 * rp * rp * sqrt(rp) * 1.0 / d_25) /
