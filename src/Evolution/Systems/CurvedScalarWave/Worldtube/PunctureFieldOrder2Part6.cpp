...
void puncture_field_2_part_6(const std::array<double, order2_n_doubles>& d,
  ...
  sc_12 = (-d[50]) * ((-ypdot) * (dv_14 * (dv_131 + dv_1997) + dv_1998 +
  ...
  sc_12 += d[52] * (dv_751 * (-Dy * dv_355 + dv_1988 * yp) +
  ...
  sc_12 += d[53] * ((-xpdot) * (-dv_14 * (dv_368 + 39.0 * dv_5) -
  ...
  sc_14 += (-d[55]) * ((3.0 * ypdot) * Dy * dv_2004 - dv_0 * dv_2002) + sc_13;
  ...
  sc_14 += (-d[19] * d[29]) *
           ((-ypdot) * (-dv_1124 + dv_14 * (dv_335 - 56.0 * dv_5) + dv_337 +
                        14.0 * dv_989) +
  ...
  sc_14 += d[52] * (dv_2008 * (-dv_2005 + dv_2007 * yp) +
  ...
  sc_16 = (d[578] * rpdot) * dv_342 + d[1074] * dv_1847 + d[48] * dv_1983 +
          dv_1985 + sc_12 + sc_15;
  ...
  sc_15 +=
      (d[20] * xp) * ((-xpdot) * dv_1654 + dv_1647 * dv_1979) + d[55] * dv_1642;
  sc_12 = d[64] * sc_15;
  ...
  sc_16 =
      d[1072] * dv_221 + dv_1627 + dv_1628 * dv_187 + dv_1629 * dv_187 +
      dv_175 * ((-d[19]) * dv_1633 +
  ...
  sc_4 = (d[1103] * d[72]) * dv_1742 + (-M) * dv_1782 * dv_1798 +
  ...
  sc_16 += (-d[337]) * (d[102] * (-dv_3034 + xpdot * (dv_14 + dv_155)) +
                        d[104] * (Dx * dv_3035 + dv_650 * xpdot) + dv_3032 -
                        116.0 * dv_3033);
  ...
  sc_16 += d[1199] * (d[102] * (dv_121 * xpdot + dv_3040 - dv_3041) +
                      d[91] * (-dv_3037 + dv_3038 * xpdot + dv_3039) +
  ...
  sc_16 += d[60] * ((-ypdot) * ((d[133] + d[1475]) * dv_96 +
  ...
  sc_15 =
      (-d[121]) * (d[210] * dv_1581 + xpdot * ((-M) * dv_154 + dv_3025 +
                                               36.0 * dv_700 + 30.0 * dv_716)) +
      (-d[1766]) * (dv_1572 + ypdot * (dv_1180 + dv_833));
  ...
  sc_15 += d[20] * ((-154.0 * d[36]) * Dx * dv_1693 +
  ...
  sc_14 =
      (-d[186]) * dv_1017 +
      (-d[206]) * ((d[144] + d[221]) * dv_1700 +
                   xpdot * ((d[1765] + d[50]) + Dy * d[239] + 64.0 * dv_1821)) +
      (d[120] * d[1755] + d[184] * xpdot) +
  ...
  sc_14 += d[205] * (-dv_2438 + xpdot * (d[135] + dv_1709)) +
  ...
  sc_18 = (-d[1198]) *
          (dv_0 * (d[1002] + dv_1637) + ypdot * (33.0 * Dy * dv_1726 - dv_629));
  ...
  sc_18 +=
      d[1199] * (-dv_1564 * dv_3048 + ypdot * (23.0 * Dy * dv_1529 - dv_656)) +
  ...
  sc_19 = (-d[202]) * dv_790 +
          Dx * ((-d[1777]) * dv_2463 + (240.0 * d[48] * rp * rpdot) * Dy +
                (-d[1776])) +
          d[52] * (dv_1696 * dv_3048 + ypdot * (dv_662 - dv_701));
  ...
  sc_19 += xp * ((-d[51]) * (35.0 * dv_0 + dv_2835) + (-240.0 * d[101]) * dv_2 +
                 (120.0 * d[48] * ypdot) * dv_635 +
                 d[20] * (152.0 * dv_1717 + 3.0 * dv_3051));
  DataVector& dv_643 = temps.at(593);
  DataVector& dv_664 = temps.at(614);
  sc_19 += xpdot * ((-120.0 * d[12]) * dv_1821 + (120.0 * d[48] * yp) * dv_635 +
                    d[50] * dv_664 - dv_643);
  sc_18 = (2.0 * M * d[92] * ypdot) * sc_19;
  ...
  sc_13 = (-d[1200]) * dv_642 + (-d[1772]) * dv_641 +
          ...
          (-d[196] * xpdot) * dv_652 + (-d[102] * d[201] * d[85]) * dv_1559 +
          (-d[148] * d[201] * xp) * dv_567 +
          (2.0 * M * d[92] * ypddot) * dv_665 +
          (4.0 * M * d[4] * ypdot) * dv_665 + sc_18 + sc_6 + sc_9;
  sc_14 = sc_13 * xpdot;
  ...
  sc_8 = (-ypddot) * dv_651 + (d[1019] * d[4]) * dv_622 +
         (d[1382] * xpddot) * dv_634 + (-d[1297] * d[178]) * dv_3012 +
         (-d[175] * d[6]) * dv_3021 + (-d[1762] * d[50]) * dv_2645 +
         (d[1247] * d[3] * d[92]) * dv_622 + (d[286] * d[4] * xp) * dv_633 +
  ...
  sc_8 += (-d[1275] * d[174] * d[19]) * dv_328 +
          ...
          d[147] * dv_623 - dv_1625 * dv_628 + dv_666 * xpddot + sc_14 + sc_15;
  sc_2 = (-d[208]) * sc_8;
  ...
  sc_12 +=
      d[1250] * (Dx * ((-d[1448]) * (d[1473] + dv_2548 + 119.0 * dv_794) +
                       (-d[276]) * ((162.0 * M + d[1552]) + dv_2910 + dv_2912) +
                       d[724] * (d[1482] - 45.0 * dv_2331 + dv_2928 + dv_2929) +
                       dv_2930) +
                 dv_2927);
  ...
  sc_12 += d[274] * ((-d[88]) * dv_2940 + d[1106] * dv_799 + d[1242] * dv_703 +
                     33.0 * dv_1904) +
           d[35] * ((M * yp) * dv_2934 + d[20] * dv_2933 - dv_2936);
  ...
  sc_9 = (-d[57]) * (Dy * d[270] + dv_772 * ypddot) +
  ...
  sc_9 += d[273] * ((-M) * (dv_2547 + dv_774 * ypddot + dv_775 * ypddot) +
  ...
  sc_10 = d[1449] * ((-d[20]) * dv_787 * ((-d[1399]) - Dy) +
                     d[259] * (dv_2924 * ypdot - dv_833) + dv_2944) +
          dv_2946 + sc_13;
  ...
  sc_18 = d[1250] * (Dx * ((-d[3]) * (d[1704] + dv_2478 + dv_2876) +
                           M * (d[306] + dv_2877 + dv_2879) - dv_2873) +
                     dv_2872) +
          dv_2886;
  ...
  sc_18 += d[27] * (dv_2880 * (dv_2854 - 8.0) + dv_2882) +
           d[31] * (-dv_2883 * dv_833 + dv_786 + dv_789 * ypdot) +
           d[6] * dv_2870;
  sc_10 = d[55] * sc_18;
  ...
  sc_10 =
      (-d[19]) *
          (d[1210] * (dv_2183 * dv_5 + dv_2185) +
           ...
           dv_2189 * ((d[1362] - 25.0 * yp) + dv_972) + dv_2192) +
  ...
  sc_10 += dv_1774 * dv_2193 + sc_12 +
           xp * (-dv_2115 * (d[88] * ((-d[1357]) - dv_69) + dv_2167) +
  ...
  sc_18 = (-d[1033]) * dv_26 + (-d[1347]) * dv_693 + (-d[1401]) * dv_1559 +
          (-d[7]) * dv_26 + (-xpddot) * (d[156] * dv_356 + dv_2244) +
  ...
  sc_13 = (-d[1]) * (M * dv_2239 + d[12] * dv_2240 - dv_1384 + dv_2238) +
  ...
  sc_13 += d[436] * ((-ypdot) * (dv_343 + dv_496) + dv_2172) +
           d[50] * (-dv_2237 + dv_579 * ypddot);
  sc_18 = d[6] * sc_13;
  ...
  sc_12 += d[1275] * dv_587 + d[1297] * dv_508 + d[1396] * dv_46 +
           ...
           d[370] * dv_1229 + d[52] * (dv_2228 * xpddot - dv_2232) + sc_15;
  ...
  sc_13 += (-d[1244]) * dv_46 + (-d[155]) * dv_48 + (-d[6]) * dv_2150 +
           (-d[6]) * dv_608 + (-d[7]) * dv_602 + (-ypddot) * dv_2148 +
           (-xp) * (dv_2154 * xpddot - dv_2160) + (-15.0 * d[1033]) * dv_670;
  DataVector& dv_2151 = temps.at(1764);
  DataVector& dv_607 = temps.at(558);
  sc_13 += (7.0 * d[6]) * dv_15 + (7.0 * d[7]) * dv_14 +
           (7.0 * yp * ypddot) * dv_14 + (25.0 * d[6] * yp) * Dy +
           (36.0 * d[7] * yp) * Dy + (11.0 * xpdot * yp * ypdot) * Dx +
           (16.0 * M * ypddot * ypdot) * dv_16 +
           xpddot * (d[1250] * dv_2151 + dv_607);
  sc_13 += (24.0 * d[142] * ypdot) * Dx * Dy +
           (24.0 * d[147] * xpdot) * Dx * Dy +
  ...
  sc_16 += d[6] * (d[162] * dv_1878 + d[20] * dv_2633 +
                   d[51] * ((85.0 * ypddot) * dv_16 - 113.0 * Dy) +
                   d[77] * (-dv_2261 + dv_2632 * ypdot)) +
           d[9] * dv_2628;
  ...
  sc_9 += d[273] * dv_2605 +
          d[6] * ((-d[50]) * (dv_2044 + dv_567 * ypddot) + d[20] * dv_2620 +
                  d[77] * (dv_1762 + dv_2619 * ypdot) + dv_682) +
          d[88] * dv_1461;
  ...
  sc_6 = Dx * ((-d[1561]) * dv_1576 + d[77] * dv_2593 + dv_2594) +
         d[1378] * ((-yp) * dv_2601 + dv_2602) + dv_2604;
  ...
  sc_6 += xpdot * ((-d[276]) * dv_2597 + (-d[77]) * dv_2599 + d[116] * dv_2600 -
                   dv_2596);
  sc_9 = d[206] * sc_6;
  ...
  sc_19 = d[27] * ((-d[1544]) * Dy + dv_2569 * ypddot) +
          d[6] * ((-yp) * dv_2578 + dv_2572 - dv_2573 + dv_2574 - dv_2575 +
                  dv_2576) +
          dv_2567;
  ...
  sc_19 += d[80] * ((4.0 * d[147]) * dv_16 - dv_2283 + dv_696 * ypdot) +
           dv_0 * ((-d[1559] + d[294] - 301.0 * d[3]) + d[165] * dv_1503 +
                   246.0 * dv_1) +
           xpddot * ((-d[1250]) * dv_2571 + dv_688);
  sc_6 = d[55] * sc_19;
  ...
  sc_18 = d[122] * ((-xpddot) * dv_2566 + d[1558] * dv_2565 - 5.0 * dv_2113 -
                    dv_2563) +
          sc_15 + sc_16 + sc_9;
  ...
  sc_18 +=
      d[52] * (d[1250] * ((-M) * dv_2584 + (-d[319]) * dv_2582 + dv_2587 * yp) +
               dv_1895 * xpddot +
               dv_2170 * ((-M) * dv_2580 + (-d[215]) * dv_1576 + dv_2579) +
               dv_2588) +
      sc_6;
  sc_13 = d[237] * sc_18;
  ...
  sc_16 += (-d[252]) * dv_463 + (xpddot * yp) * dv_2326 +
           (4.0 * d[48] * ypdot) * dv_14 + (18.0 * M * d[1275] * yp) * dv_16 +
           (40.0 * d[48] * yp * ypdot) * Dy +
           (110.0 * M * d[20] * ypddot) * dv_15 +
           (183.0 * M * d[1274] * yp) * dv_16 +
           (330.0 * M * d[7] * yp) * dv_15 - dv_2323 - dv_2324;
  ...
  sc_15 += d[31] * ((-d[147]) * dv_328 + (-ypdot) * dv_725 + dv_2283);
  DataVector& dv_2279 = temps.at(1873);
  DataVector& dv_2280 = temps.at(1874);
  DataVector& dv_2282 = temps.at(1876);
  sc_15 += dv_0 * (M * (d[1406] - dv_2281 - dv_2282) +
                   d[256] * ((50.0 * M) - dv_2280) - dv_2279);
  sc_16 = d[19] * sc_15;
  ...
  sc_19 = (-xpddot) * dv_2273 +
          Dx * ((-d[1033]) * dv_2270 + (8.0 * d[147]) * dv_1529 +
                (41.0 * M * d[7]) - dv_2269) +
          dv_2267 * dv_728 + dv_2268 * ((55.0 * M - d[261]) - dv_1667);
  ...
  sc_17 += yp * (dv_2298 * ((-yp) * dv_2297 + d[1412] * dv_2296 - dv_2294) -
                 dv_2299);
  sc_19 = sc_17 * xp;
  ...
  sc_16 += d[321] * (-dv_1762 + dv_786 + dv_831 * ypdot) +
  ...
  sc_9 = d[273] * dv_2652 + d[276] * ((5.0 * ypdot) * dv_817 - dv_2661) +
  ...
  sc_9 += d[57] * ((-ypddot) * dv_2649 + dv_2647) + sc_17;
  sc_16 = sc_9 * yp;
  ...
  sc_19 = (-d[52]) * dv_2646 + (-xp) * dv_2676 +
          d[122] * ((-xpddot) * dv_2636 + d[1250] * dv_2634) + sc_15;
  ...
  sc_19 += d[55] * (d[6] * (-dv_101 - dv_2638 - dv_94) +
                    ...
                    dv_2640 + xpddot * ((26.0 * d[648]) * dv_835 + dv_1901));
  sc_19 += sc_16;
  sc_6 = d[331] * sc_19;
  ...
  sc_9 +=
      xpdot *
      ((-d[1472]) * (d[1498] + dv_2468 - 354.0 * dv_794) + (141.0 * d[1135]) +
       d[1409] * ((6.0 * M) * (dv_2473 + dv_2474) + (-d[1500]) - 158.0 * dv_1) +
  ...
  sc_21 += d[50] * ((12.0 * M) * (dv_2459 + dv_2461) + (-168.0 * d[255]) -
                    199.0 * dv_1);
  sc_20 = sc_21 * xpdot;
  ...
  sc_21 = (-d[1254]) * ((-d[1481]) * dv_1503 + d[1502] - 130.0 * dv_2246 +
                        dv_2411 + dv_2481) +
          (-d[1452]) *
              ((-M) * (26.0 * dv_1502 + dv_2480 + 3.0) + d[1501] + dv_2479) +
          900.0 * dv_2442 - dv_2475;
  DataVector& dv_2231 = temps.at(1833);
  DataVector& dv_2427 = temps.at(2017);
  sc_21 += (-d[535]) * ((-d[1450]) * (d[166] + 217.0 * dv_1) +
                        (3.0 * d[50]) * (d[1503] + dv_2231) +
                        (3.0 * d[48] * yp) * ((20.0 * M * ypdot) - 31.0 * Dy) +
  ...
  sc_20 = (-xpdot) *
          ((-d[48]) * dv_2418 + (141.0 * d[276]) +
           ...
           d[348] * ((4.0 * M) * (52.0 * dv_1502 + 26.0 * dv_1503 + 3.0) +
  ...
  sc_20 += (d[1244] * (-d[1476] - 124.0 * d[36])) * dv_231 +
           d[1256] * ((17.0 * ypdot) * Dx - dv_2436 - dv_2437) +
  ...
  sc_22 = (-d[1376]) *
          ...
          (-d[286]) *
              ((-7.0 * yp) * (d[1362] + dv_2237) + d[388] + 180.0 * dv_1229);
  ...
  sc_22 +=
      ...
      (2.0 * d[20]) * (d[1271] + dv_2431 + dv_2432) + (4.0 * M) * dv_2434;
  sc_20 = d[299] * sc_22;
  ...
  sc_23 =
      (-d[1422]) * ((217.0 * d[7] - 15.0) * dv_2444 +
                    (d[1484] - 49.0 * ypdot) * dv_2445 + d[1483] * dv_1112 +
                    d[51] * (51.0 * dv_2375 + 75.0 * dv_2376 - 79.0 * dv_751)) -
      1560.0 * dv_2442;
  sc_23 += (d[6] * yp) * (d[1299] * ((-d[1482]) - 205.0 * dv_1) + d[1480] +
                          d[20] * ((708.0 * d[36]) + 365.0 * Dy) +
                          d[559] * ((12.0 * M * ypdot) - dv_2044)) +
           sc_24;
  sc_22 = d[55] * sc_23;
  ...
  sc_16 += d[362] * (d[1106] * ((-d[306]) * dv_1805 + dv_1634) +
                     xpdot * ((194.0 * ypdot) * Dy +
                              (48.0 * M * d[7] - d[1467]) - dv_2425) +
  ...
  sc_16 +=
      d[57] * ((d[20] * (-24.0 * d[1242] + 97.0 * ypdot) + 14.0 * d[252] +
                d[511] * (1.0 - d[270])) *
                   dv_1819 +
               Dx * d[1469] + d[1470] * dv_2426 +
               d[6] * ((-d[1472]) * (M + dv_2429) + (3.0 * d[50]) * dv_2430 +
                       (92.0 * d[48] * yp) * Dy + (-d[1471]) - dv_2428));
  ...
  sc_9 = d[253] * ((-d[1]) * (dv_2358 + dv_2536 - 9.0) + d[153] + dv_2255) +
         d[259] * ((-d[1599]) + M * (48.0 * dv_1502 + dv_2731 + 29.0) -
                   129.0 * dv_1 - dv_2730);
  ...
  sc_21 = (d[1193] + d[1344] + 29.0 * ypdot) * dv_2722 +
          (d[1249] * (d[1595] + 17.0) + d[20] * (d[1407] - 23.0 * ypdot) -
           201.0 * d[252]) *
              dv_2725 +
  ...
  sc_21 += d[1449] * ((-d[116]) * (d[444] + dv_2727) +
                      (48.0 * M * yp) * dv_2401 + (19.0 * d[50]) - dv_2726) +
           d[391] * dv_1112 +
  ...
  sc_23 += d[631] * ((130.0 * d[255]) + M * (-126.0 * dv_1503 + dv_2552) +
                     131.0 * dv_1 + dv_2720);
  sc_15 = sc_23 * xpdot;
  ...
  sc_23 += d[631] * (M * (dv_2300 + dv_2743) - 373.0 * dv_1 - dv_2744);
  sc_9 = (-xpdot) * sc_23;
  ...
  sc_15 += d[1378] * ((-d[370]) * (Dy + d[36]) + (M * yp) * (M + dv_2741) +
                      (-d[1444]) - 92.0 * dv_1821) +
           d[1439] * ((155.0 * ypdot) * Dx - 305.0 * dv_2376 - dv_2436);
  DataVector& dv_2335 = temps.at(1926);
  sc_15 +=
      d[51] * (d[1606] * dv_1805 + dv_2335 * xpddot - 57.0 * dv_2379 + dv_2465);
  sc_17 = d[124] * sc_15;
  ...
  sc_24 = (-d[57]) * (dv_2738 + dv_2739) +
          ...
          d[273] * ((-xpddot) * dv_2682 + (128.0 * d[147]) * Dx +
  ...
  sc_24 =
      (-d[209]) * (M * ((126.0 * xpddot) * Dx - dv_2157) + d[255] + dv_2367) +
      (14.0 * d[1584]) * dv_2349 + d[1411] * ((-d[1428]) - dv_2487 - dv_2702) +
      d[1586] * dv_1 + sc_25;
  ...
  sc_24 += d[243] * (M * (dv_2114 + dv_2448) + d[255] * dv_2703 - dv_2135);
  ...
  sc_25 = (d[1460] + yp * (-d[1106] + d[1407])) * dv_2268 +
          (-xpdot) * (d[1] * (dv_2361 + dv_2500) +
  ...
  sc_22 += d[1466] * (d[1057] * ((-d[1582]) - Dy) + d[147] * dv_1513 + d[153] +
                      d[3] * dv_2343 + dv_2484 +
  ...
  sc_9 = (-d[1423]) * ((-d[262]) - dv_558) + (-d[1425]) * dv_2268 +
         ...
         d[36] * ((57.0 * M * xpddot) * Dy - 23.0 * dv_751);
  DataVector& dv_1881 = temps.at(1390);
  DataVector& dv_2348 = temps.at(1938);
  sc_9 +=
      xpdot * ((-d[46]) * ((-d[1304]) * dv_1503 + d[1427] + dv_2348) +
               d[243] * (d[1428] + dv_2114 + dv_2300) + d[256] * (M + dv_1881));
  DataVector& dv_2347 = temps.at(1937);
  DataVector& dv_729 = temps.at(678);
  sc_9 += yp * (d[147] * dv_729 - dv_2346 + dv_2347);
  sc_23 = d[122] * sc_9;
  DataVector& dv_2357 = temps.at(1947);
  sc_15 = (d[1249] * (d[1264] + d[1304] * ypddot) + d[1409] * ypddot +
  ...
  sc_17 +=
      (-d[346]) * (-dv_2380 + dv_2381) +
      (2.0 * d[142] * yp) * ((d[1444] - d[1445] * yp) + dv_2385 + dv_2386) +
      (4.0 * d[57] * ypdot) * (4.0 * dv_1803 + dv_2345) +
      (4.0 * d[6] * yp * (d[1440] + d[1442] + 20.0 * d[319])) * Dx + sc_21;
  sc_15 = d[52] * sc_17;
  sc_20 = xpdot;
  ...
  sc_20 *= (-d[1443]) * (d[484] + dv_2231 + dv_2405) + d[1454] * dv_2401 +
           ...
           d[273] * ((-d[1455]) + M * (73.0 * dv_1503 + dv_2407 + 17.0) -
                     89.0 * dv_1);
  ...
  sc_20 = (-d[48]) * dv_2364 + Dx * d[1432] + d[1433] * (dv_2358 + dv_2360) +
          d[159] * (M * (73.0 * dv_1502 + dv_2369 + 17.0) + d[1403] + dv_2367);
  ...
  sc_20 += xpdot * (d[1409] * (4.0 * dv_1805 + dv_2373) +
  ...
  sc_25 += d[274] * (M * (148.0 * dv_1502 + dv_2414 + 17.0) + d[1459] +
                     52.0 * dv_1) +
  ...
  sc_25 += xpdot * ((209.0 * d[7] - 17.0) * dv_2421 + d[151] * dv_2419 +
                    d[225] * (dv_2263 + dv_2373) +
                    d[631] * (d[1465] * dv_1803 + dv_2423 + dv_2424 * xpddot) +
                    84.0 * dv_2420);
  sc_20 = d[63] * sc_25;
  ...
  sc_24 = d[1419] * dv_2340 +
          d[299] * ((-M) * dv_2342 + d[1376] * dv_2343 + d[1420] +
                    d[1422] * (dv_1112 + dv_2344 * yp) +
                    d[286] * ((M + d[1421]) + dv_2270) - 4.0 * dv_2169) +
          sc_15 + sc_23 + sc_9;
  ...
  sc_23 += d[319] * ((-d[1694]) + M * (-1008.0 * dv_1502 - dv_2842 - 47.0) +
                     360.0 * dv_1) +
  ...
  sc_15 += sc_9 + xpdot * ((d[1242] - d[1693]) * dv_2722 +
  ...
  sc_9 = (-d[1708]) * dv_2824 + (6.0 * d[1711]) * dv_2136 +
         d[273] * ((8.0 * M) * (-dv_2359 - dv_2858) + (371.0 * ypdot) * Dy +
                   (-d[1606]) - 868.0 * dv_2246);
  DataVector& dv_2855 = temps.at(2407);
  DataVector& dv_2856 = temps.at(2408);
  sc_9 += d[276] * ((-M) * (252.0 * dv_1502 + 248.0 * dv_1503 + 53.0) +
  ...
  sc_9 += d[630] * (M * (dv_2488 + dv_2857) + d[153] + dv_2152) +
          xpdot * ((d[1031] * d[339] - d[1450] * (715.0 * d[7] - 47.0) +
                    d[287] * (d[1242] + d[1314]) +
                    d[51] * (-126.0 * d[1242] + d[1714] + 145.0 * ypdot) -
                    d[807] * (d[1620] + 9.0)) *
                       Dx +
                   d[1713] * dv_1808);
  sc_15 = d[341] * sc_9;
  ...
  sc_27 += (4.0 * d[48] * yp) * (M * (dv_2488 + dv_2552) + d[1406] + dv_2429) +
           d[50] * ((1135.0 * d[255]) +
  ...
  sc_25 = (-d[1359]) * ((d[1553] + d[1665]) + d[50] * (d[257] - dv_2555) +
                        220.0 * dv_2831 + dv_2852) +
          (-d[1417]) * (-dv_2008 + dv_2381) + (-d[532]) * dv_2850 +
          (-1001.0 * M * d[20] * ypdot + d[1107] - 28.0 * d[151] * ypdot +
           d[230] * ypddot + d[58] * (d[1705] + 30.0)) *
              dv_2268;
  DataVector& dv_2851 = temps.at(2403);
  sc_25 += (2.0 * d[57]) * (d[1703] * dv_2698 + 35.0 * dv_1803) +
           (2.0 * M * d[20]) *
               (d[306] * dv_1803 - 381.0 * dv_2379 + dv_2383 + dv_2851);
  sc_25 += (2.0 * d[50] * ypdot) *
               ((-d[1704]) * dv_1803 + (245.0 * ypdot) * Dx - 504.0 * dv_2376) +
           sc_26;
  sc_23 = d[343] * sc_25;
  ...
  sc_28 = (-d[1594]) * dv_2833 + (-d[287]) * (dv_2500 + dv_2835) +
          (-d[502]) * dv_2695 +
          (2.0 * M * d[20]) * (d[1362] + dv_2834 - 1104.0 * dv_794);
  DataVector& dv_2836 = temps.at(2388);
  sc_28 += d[50] * ((249.0 * d[255]) + M * (-245.0 * dv_1503 + dv_2552) +
                    230.0 * dv_1 + dv_2836);
  sc_27 = sc_28 * xpdot;
  ...
  sc_26 += yp * ((-d[1322]) * (dv_2543 + dv_2832) +
                 (-d[274]) * (245.0 * dv_1805 + dv_2721) + d[1687] * dv_2263 +
                 d[807] * dv_2339);
  sc_25 = d[344] * sc_26;
  ...
  sc_29 = (-d[1702]) * ((-d[1684]) - dv_2406 - dv_2847) +
          (-d[287]) * (M * (-dv_2549 - dv_2848) + d[167] + dv_582);
  DataVector& dv_2849 = temps.at(2401);
  sc_29 += (-d[631]) * (-141.0 * Dy + d[1701] + 2002.0 * dv_794) +
           (8.0 * d[151] * d[7]) * Dy +
           d[50] * ((-M) * (230.0 * dv_1502 + 1016.0 * dv_1503 + 103.0) +
  ...
  sc_27 =
      (-d[1319] + d[1699] + d[1700] * (d[1580] + 25.0) - 1627.0 * d[274] +
       d[457] * ypddot) *
          dv_2268 +
      d[1411] * ((375.0 * ypdot) * Dx - 110.0 * dv_2375 - 508.0 * dv_2376) +
  ...
  sc_30 += yp * ((-M) * (248.0 * dv_1502 + dv_2830 + 53.0) + (239.0 * d[255]) +
                 290.0 * dv_1 + dv_2829);
  sc_29 = d[86] * sc_30;
  ...
  sc_28 =
      (d[185] * ypddot - 552.0 * d[36] + yp * (51.0 * d[7] + 140.0)) * dv_2528 +
      (-12.0 * d[1242] + 13.0 * d[147] + 53.0 * ypdot) * dv_2827 +
      d[1412] * (dv_2526 - dv_2716 + dv_2828) +
      d[1423] * ((-d[1682]) - dv_2261 + yp * (d[1495] + dv_2227)) - dv_2826;
}
}  // namespace CurvedScalarWave::Worldtube::detail
