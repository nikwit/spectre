...
void puncture_field_acc_1(
    ...
    const double fydot, const double Duft, const double Dufx, const double Dufy,
    const double Duftdot, const double Dufxdot, const double Dufydot,
  ...
  const double d_77 =
      -M * (-2 * d_10 - 2 * d_73 - 2 * d_74 - 2 * d_9 + rpdot) * 1.0 / d_6 +
  ...
  const double d_130 = Dufy * d_127;
  const double d_131 = Duft * d_66;
  const double d_132 = 4 * yp;
  const double d_133 = Dufx * d_36;
  ...
  const double d_145 = d_83 * 1.0 / d_111;
  const double d_146 = M * yp;
  const double d_147 = d_146 * d_48;
  const double d_148 = Dufx * d_127;
  const double d_149 = Dufy * d_19;
  ...
  dv_122 = 6 * M * d_6 * dv_61 * dv_8 * ft +
           12 * d_24 * d_29 * d_30 * dv_40 * ft +
           12 * d_30 * d_31 * d_38 * dv_40 * fx +
           12 * d_30 * d_31 * d_41 * dv_40 * fy - d_49 * dv_84 - d_52 * dv_86 -
           d_55 * dv_87 - dv_121 - dv_63 * dv_70 - dv_71 * dv_76 -
           dv_77 * dv_81 - dv_81 * dv_82 - dv_88 * dv_89;
  ...
  get(get<CurvedScalarWave::Tags::Psi>(*result)) =
      -1.0 / 12.0 * d_67 * 1.0 / dv_18 *
      (d_22 * dv_34 + d_67 * dv_122 * 1.0 / dv_17 + dv_19 * dv_21 + dv_27 +
       dv_31 + 6 * dv_37 + 6 * dv_39);
      ...
      (-d_56 * d_59 * d_78 * dv_125 + 54 * d_60 * d_69 * dv_125 -
       ...
       d_86 * dv_162 *
           (4 * M * d_12 * d_20 * dv_134 * dv_5 * ft +
            ...
            d_93 * dv_159 * dv_20 - dv_123 * ftdot - dv_138 * dv_36 -
       ...
       d_97 * dv_163 *
           (48 * Duft * M * d_45 * d_56 * dv_134 * dv_17 * dv_5 * dv_8 +
            28 * Duft * M * d_59 * d_60 * dv_17 * dv_5 * dv_92 * rpdot +
            4 * Duft * M * d_59 * d_66 * dv_139 * dv_17 * dv_92 +
            12 * Duft * M * d_59 * d_66 * dv_150 * dv_17 * dv_5 * dv_9 +
            36 * Duft * M * d_59 * d_68 * d_77 * dv_5 * dv_79 * dv_8 +
            4 * Duftdot * M * d_59 * d_66 * dv_17 * dv_5 * dv_92 -
            Duftdot * d_45 * d_56 * dv_21 * dv_88 +
            12 * Dufx * d_108 * d_59 * dv_17 * dv_24 * dv_92 * rpdot +
            18 * Dufx * d_112 * d_59 * d_77 * dv_24 * dv_79 * dv_8 +
            24 * Dufx * d_45 * d_46 * dv_134 * dv_17 * dv_24 * dv_8 +
            2 * Dufx * d_59 * d_60 * dv_143 * dv_17 * dv_92 +
            6 * Dufx * d_59 * d_60 * dv_150 * dv_17 * dv_24 * dv_9 -
            Dufx * dv_143 * dv_81 +
            2 * Dufxdot * d_59 * d_60 * dv_17 * dv_24 * dv_92 -
            Dufxdot * dv_24 * dv_81 +
            12 * Dufy * d_108 * d_59 * dv_17 * dv_28 * dv_92 * rpdot +
            18 * Dufy * d_112 * d_59 * d_77 * dv_28 * dv_79 * dv_8 +
            24 * Dufy * d_45 * d_46 * dv_134 * dv_17 * dv_28 * dv_8 +
            2 * Dufy * d_59 * d_60 * dv_147 * dv_17 * dv_92 +
            6 * Dufy * d_59 * d_60 * dv_150 * dv_17 * dv_28 * dv_9 -
            Dufy * dv_147 * dv_81 +
            2 * Dufydot * d_59 * d_60 * dv_17 * dv_28 * dv_92 -
            Dufydot * dv_28 * dv_81 +
            6 * M * d_12 * d_20 * dv_103 * dv_134 * fy +
            6 * M * d_12 * d_20 * dv_134 * dv_97 * fx +
            12 * M * d_12 * d_64 * dv_114 * dv_134 * ft +
            6 * M * d_6 * dv_150 * dv_61 * ft +
            6 * M * d_6 * dv_61 * dv_8 * ftdot - M * dv_114 * dv_117 * ftdot +
            ...
            6 * d_21 * dv_98 *
                (M * dv_110 * dv_194 + d_121 * dv_192 +
                 ...
                 dv_20 * (-d_12 * dv_106 * dv_194 - d_122 * dv_107 +
                          ...
                          dv_203 * dv_204)) +
            12 * d_24 * d_29 * d_30 * dv_40 * ftdot +
            192 * d_29 * d_30 * d_31 * dv_40 * ft * rpdot -
            120 * d_29 * d_87 * dv_169 - 12 * d_29 * dv_84 * ftdot +
            12 * d_30 * d_31 * d_38 * dv_40 * fxdot +
            12 * d_30 * d_31 * d_41 * dv_40 * fydot +
            180 * d_30 * d_38 * d_98 * dv_40 * fx * rpdot +
            180 * d_30 * d_41 * d_98 * dv_40 * fy * rpdot -
            156 * d_46 * dv_118 * dv_166 - d_52 * dv_169 * fxdot -
            d_55 * dv_169 * fydot - d_57 * d_96 * dv_120 * dv_20 * dv_92 -
            d_61 * dv_157 *
            ...
            d_61 * dv_158 *
                (-d_125 * dv_101 + d_125 * dv_73 + d_126 * dv_56 +
                 ...
                 dv_232 + dv_233) -
            d_61 * dv_99 * fxdot - d_78 * d_98 * dv_115 * dv_17 -
            42 * d_91 * dv_114 * dv_98 - dv_103 * dv_105 * fydot -
