...
void puncture_field_2_part_9(const std::array<double, order2_n_doubles>& d,
  ...
  sc_30 += d[59] * (d[31] * (Dx * (dv_2459 - 5.0) + dv_143 * xpddot) + dv_3569 +
                    dv_3578) +
  ...
  sc_9 = d[1035] *
             ((-d[2167]) * dv_2975 + (-d[2293]) * (d[2292] * dv_15 + dv_3556) +
              (-d[2291] * yp) * dv_3154 + d[1641] * dv_740 +
              d[762] * (dv_29 + dv_425)) +
         sc_17 + sc_18;
  ...
  sc_31 =
      ...
      d[223] * ((-d[37]) * (dv_2114 - 25.0) + (12.0 * M * d[147]) - dv_3561);
  ...
  sc_31 +=
      d[308] * ((2.0 * M) * (508.0 * dv_1503 + 103.0) +
                (72.0 * d[1976] * ypdot) * Dy + (-2257.0 * d[255]) - dv_3579) +
      d[355] * ((d[2275] + 1.0) * dv_1631 + (-M) * dv_3070 + d[153]);
  sc_30 = Dy * sc_31;
  DataVector& dv_1571 = temps.at(1443);
  sc_17 = (M * (-d[1031] * d[235] + d[1107] * (d[1193] - d[1338]) +
                d[1340] * d[154] +
  ...
  sc_17 *= (-d[235]) * dv_2863 + (-d[273]) * (d[306] + 13269.0 * dv_1) +
           (96.0 * d[48] * yp) * ((-d[1967]) * dv_240 + (-d[1399])) +
  ...
  sc_15 +=
      d[265] *
      ((-d[1716]) * dv_115 +
       Dy * yp * ((9.0 * d[20]) * (d[1786] + dv_2227) + (-d[2297]) - dv_2845));
  ...
  sc_15 += d[355] * ((d[1276] * d[2177]) * dv_45 +
                     d[36] * ((-xpddot) * dv_691 + dv_1583 + 2.0 * dv_2158) -
                     dv_3548 + dv_3592);
  DataVector& dv_3287 = temps.at(2774);
  DataVector& dv_3324 = temps.at(2810);
  DataVector& dv_3506 = temps.at(2980);
  sc_15 += d[604] * ((-d[1616]) * Dx + (8.0 * M) * (dv_3324 + dv_3506) +
                     (2.0 * d[2304] * ypdot) * Dx * Dy - 1125.0 * dv_3287) +
           sc_17;
  sc_9 = d[1905] * sc_15;
  ...
  sc_25 += (M * d[361]) *
           (d[6] * ((-d[101]) * dv_503 + d[1339] * dv_123 + d[274] * dv_3562 +
                    dv_190 * dv_2815) +
            dv_1017 * ((d[1048] + d[1680] - 3.0) * dv_833 + dv_3560 * yp) +
  ...
  sc_13 +=
      (d[50] * xp) * (d[1250] * dv_3388 + d[2144] * dv_45 + 154.0 * dv_3251) +
      (d[52] * yp) * ((d[2145] * d[273] - d[2146]) * dv_801 + d[2040] * dv_567 +
                      326.0 * dv_3251 + dv_3396 * xpdot) +
      sc_29;
  DataVector& dv_1200 = temps.at(1095);
  sc_13 += (-d[2121] * xpdot) * (dv_1200 + dv_29);
  ...
  sc_13 += d[55] * (d[76] * dv_3403 + dv_240 * dv_3409 +
                    yp * ((-d[563]) * dv_647 + d[1628] * (dv_122 + dv_535) +
  ...
  sc_29 += d[274] * (Dx * (M * (dv_2459 + 17.0) + d[1671] + 78.0 * dv_1) +
  ...
  sc_14 = (-d[120]) *
          ((-d[20]) *
               ((-ypdot) * dv_26 + d[147] * dv_106 + dv_0 * dv_2647 + dv_3373) +
  ...
  sc_14 +=
      d[2114] * ((-d[2111] * d[259] + d[2113]) * dv_45 + d[1740] * dv_781 +
                 xpdot * ((-d[104]) * dv_2960 + d[20] * dv_2962 - dv_2981));
  ...
  sc_14 += d[300] * ((-d[2106]) * dv_1717 + (-d[6]) * dv_2956 +
                     (-d[1623] - d[9]) * dv_14 + (10.0 * yp * ypdot) * dv_15) +
           d[362] * ((-xpdot) * dv_29 + d[142] * dv_106 + dv_3097 + dv_3372);
  sc_6 = d[1108] * sc_14;
  ...
  sc_16 += d[252] * (dv_1762 + dv_3338 * ypdot);
  sc_28 = sc_16 * xpdot;
  ...
  sc_12 += d[159] * (Dx * ((-M) * (dv_2368 - 17.0) + (-d[1404]) - dv_3035) +
  ...
  sc_28 = (-d[142]) * dv_34 + Dx * d[1420] + d[1376] * dv_3325 +
          ...
          xpdot * (d[354] * dv_3327 + ypdot * (dv_2691 + 21.0 * dv_833));
  ...
  sc_16 = (-d[249]) * dv_3331 +
          (-d[6]) * ((-d[1262] + d[1724]) * dv_29 +
                     Dy * ((-yp) * (d[1438] + dv_2250) + (d[1679] + d[2097]))) +
          d[36] * ((-ypdot) * dv_3329 + 57.0 * dv_2692) + dv_2951 * dv_3328;
  DataVector& dv_2220 = temps.at(1822);
  DataVector& dv_3332 = temps.at(2818);
  DataVector& dv_3334 = temps.at(2820);
  sc_16 += xpdot * (Dx * d[556] * (d[1481] + dv_2824) + d[248] * dv_3334 -
                    dv_2443 * dv_3332) +
           yp * ((-d[1242]) * dv_3329 + d[1434] * dv_2220 + d[1906] * dv_635 +
                 42.0 * dv_2293);
  sc_28 = d[2098] * sc_16;
  ...
  sc_24 += Dy * yp *
           ((-d[273]) * (d[1428] + dv_2353) +
            ...
            (4.0 * d[50] * xpddot * ypdot) * Dx - dv_2351);
  sc_16 = d[225] * sc_24;
  ...
  sc_30 = (-d[20]) * (dv_2641 - dv_3343) +
          (-d[48]) * ((-ypdot) * (505.0 * dv_14 + 297.0 * dv_15) + dv_2261) +
          (-d[50]) * dv_2330;
  DataVector& dv_2370 = temps.at(1960);
  sc_30 += (M * yp) * (Dy * ((-233.0 * d[36]) + dv_2370) + 65.0 * dv_14);
  sc_18 = d[35] * sc_30;
  ...
  sc_17 = (-d[1443]) * ((-d[147]) * dv_3357 + (M * ypddot) * dv_635 - dv_2938 -
                        dv_3278) +
  ...
  sc_12 = (-d[1161]) * dv_31 +
          (-d[1443]) * ((-ypdot) * (d[2015] * dv_821 + dv_2632) + dv_2261) +
          (2.0 * d[50]) *
              ((85.0 * M) * dv_1559 + d[2015] * dv_739 - 113.0 * dv_833);
  DataVector& dv_2633 = temps.at(2211);
  DataVector& dv_840 = temps.at(783);
  sc_12 += (M * d[20]) * (d[2015] * dv_840 + dv_2633);
  sc_28 = d[6] * sc_12;
  ...
  sc_16 += (-d[2029]) * dv_3152 + (-d[2029]) * dv_3155 + (-d[273]) * dv_3012 +
           ...
           (d[151] * rpdot) * dv_209 + d[1232] * dv_2630 + d[151] * dv_2130;
  ...
  sc_16 += dv_1564 * ((-d[631]) * ((357.0 * rpdot - 113.0) * dv_1552 +
                                   (-d[9]) * dv_3236 + d[1571]) +
                      d[101] * ((1564.0 * rpdot - 27.0) * Dy +
  ...
  sc_14 =
      d[1443] * (dv_1762 + ypdot * (d[2017] * dv_16 + dv_2619)) +
      d[273] * ((170.0 * rpdot) * dv_543 + dv_2620) +
      d[50] * ((-d[1242]) * dv_567 + (68.0 * rpdot * ypdot) * dv_16 - dv_2641);
  ...
  sc_28 += (-d[273]) * dv_2176 + (-d[50]) * dv_2173 +
           (-408.0 * rpdot) * dv_3155 + (-204.0 * d[50]) * dv_3148 +
           (-72.0 * d[604]) * dv_3175 + (d[276] * rpdot) * dv_149 +
  ...
  sc_28 += -dv_1237 *
           ((2.0 * d[20]) * (M * (2.0 - dv_3177) + d[1457] + dv_3223) +
            (2.0 * M * yp) *
  ...
  sc_6 += xpdot * ((-d[276]) * dv_2597 + (-d[77]) * dv_2599 +
  ...
  sc_12 = (34.0 * d[1792]) *
              ((-d[2021] * d[259] + d[2023]) * dv_416 +
               (d[315] * d[638]) * dv_45 + d[325] * dv_779 + dv_824 * xpdot) +
          sc_14;
  sc_28 = (-d[206]) * sc_12;
  ...
  sc_14 = M * (d[1250] * ((-M) * dv_2584 + (-d[319]) * dv_2582 + dv_2587 * yp) +
               dv_2170 * ((-M) * dv_2580 + d[215] * dv_1542 + dv_2579) +
  ...
  sc_6 += (-d[1240]) * ((-d[1250]) * (M * dv_2680 + d[1474] * dv_16 + dv_2570) +
                        dv_688) +
          (-d[27]) *
              ((-ypdot) * ((-d[2016]) * dv_816 + dv_2763) + d[1242] * dv_2569);
  ...
  sc_6 += (M * d[6]) * ((-442.0 * rpdot) * dv_835 - dv_2572 + dv_2573 +
                        dv_2575 - dv_2576 + dv_2578 * yp + dv_420);
  DataVector& dv_3005 = temps.at(2530);
  sc_6 += Dx * xpdot *
          ((-yp) * ((-301.0 * d[36]) + dv_3005 * rpdot) +
           d[1] * ((-M) * (dv_3177 + 40.0) + d[1427] + dv_3223));
  sc_14 = d[55] * sc_6;
  ...
  sc_15 = d[122] * ((d[2015] * xpdot) * (dv_2144 + dv_2635) +
                    M * ((-d[1558]) * dv_2565 + dv_2563 - 5.0 * dv_3057) +
                    d[1240] * dv_2566) +
  ...
  sc_24 = (-d[115]) * ((-xpddot) * dv_3266 - dv_3471 - dv_3488) +
          dv_3105 * ((4.0 * M) * (dv_2805 + dv_3222 + 35.0) +
                     (-288.0 * d[255]) - dv_3489);
  ...
  sc_24 += d[162] * dv_751 * (M + dv_2589) +
           dv_3487 * ((129.0 * d[36]) + d[2201] * dv_3140 + dv_2839 * rpdot);
  sc_16 = (-d[86]) * sc_24;
  ...
  sc_28 = (-d[1463]) * (-Dy * ((-d[534]) - dv_2390) + dv_3266 * ypddot) +
          (-d[2197]) * ((-d[252]) * dv_450 + (d[367] * ypdot) * dv_3482 +
                        d[259] * dv_3483);
  ...
  sc_28 +=
      (18.0 * d[274]) * (-dv_3478 + dv_3479 + dv_3480 * ypdot) +
  ...
  sc_6 = d[2197] * ((d[1681] * yp) * dv_29 + d[36] * dv_3477) +
  ...
  sc_6 += d[346] * (-dv_1709 * ((-d[534]) - dv_1502) + dv_258 * ypddot) +
          d[396] * ((-ypdot) * (105.0 * dv_14 + dv_15) + 27.0 * dv_3475);
  sc_24 = (-xpdot) * sc_6;
  DataVector& dv_2813 = temps.at(2366);
  DataVector& dv_3474 = temps.at(2949);
  sc_29 = d[249] * (dv_258 * xpddot + dv_3474) +
  ...
  sc_29 += yp * (d[1714] * dv_45 - dv_2172 * (43.0 * dv_1803 + dv_1805) +
  ...
  sc_29 +=
      xpdot * ((-162.0 * ypddot) * dv_1448 + 324.0 * dv_2293 +
               ypdot * ((-d[2192]) * dv_14 + (1715.0 * rpdot + 630.0) * dv_15));
  sc_24 = (-d[273]) * sc_29;
  DataVector& dv_265 = temps.at(258);
  DataVector& dv_3104 = temps.at(2596);
  sc_6 =
      d[50] * (-Dy * ((63.0 * d[1240] - 16.0 * d[142] - d[2191] * xpdot) * Dy +
                      dv_3104) +
               d[7] * ((d[1934] * xpdot) * dv_123 + Dx * d[46]) +
  ...
  sc_6 += (-d[807]) * dv_752 * ((-d[2192]) * dv_1 + dv_2118) +
          dv_1823 * ((-d[142]) * dv_1676 - dv_2757 + 324.0 * dv_3243 +
                     xpdot * ((-d[2193]) * dv_3469 + d[1362] + 765.0 * dv_794));
  DataVector& dv_2339 = temps.at(1929);
  DataVector& dv_3053 = temps.at(2546);
  sc_6 += Dy * d[198] * (dv_2339 + dv_3053 * xpdot);
  sc_16 = d[1797] * sc_6;
  ...
  sc_24 += d[1105] * ((-M) * (43.0 * dv_3138 + xpddot * (dv_128 + dv_15)) +
  ...
  sc_24 +=
      d[1463] * (dv_26 * xpddot + dv_3490 + dv_3491) +
      d[273] *
          (d[2203] * dv_3247 +
  ...
  sc_24 += -dv_3492 * ((-M) * dv_3102 + d[1054] + d[1847] * dv_2280 + dv_2801);
  sc_6 = d[1800] * sc_24;
  ...
  sc_17 =
      (-d[273]) * ((-M) * dv_2468 * dv_2755 + Dx * dv_3489 + 324.0 * dv_2435) +
  ...
  sc_13 = (-d[1105]) * ((-d[255]) * dv_2978 + (d[1481] * ypddot) * dv_282 +
                        dv_3365 + dv_3386) +
  ...
  sc_13 +=
      d[1439] * ((-165.0 * ypdot) * dv_282 + d[1272] * dv_1820 +
                 dv_1762 * (dv_3508 + 35.0) + dv_3507) +
      d[1937] * ((-d[2233] * d[273] + d[2234]) * dv_14 + d[2232] * dv_3145);
  DataVector& dv_292 = temps.at(284);
  sc_13 += d[287] * ((-70.0 * ypdot) * dv_292 + d[1257] * dv_1820 +
                     d[1291] * dv_31 + dv_3354 + dv_3478);
  sc_13 += d[6] * ((-d[1716] * d[1937] + d[2211] - 462.0 * d[273] +
                    480.0 * d[276] + 4230.0 * d[277]) *
                       dv_14 +
                   dv_5 * ((-d[1724] * yp) * ((d[1940] + 6.0) * Dy + d[1881]) +
  ...
  sc_18 =
      (-d[198]) * (dv_3257 * xpddot + dv_3361 + dv_3471) +
      (d[2225] * d[271]) * dv_732 +
  ...
  sc_17 += (-d[51]) * ((-d[1414]) * dv_3257 + d[1291] * dv_3512 +
           ...
           (d[1483] * d[7]) * dv_1836 +
           d[1463] * (Dy * (d[1684] + dv_2390) + dv_3257 * ypddot);
  ...
  sc_31 = (-d[101]) *
          ((d[2229] - 639.0 * d[7] + 140.0) * dv_14 +
           Dy * ((280.0 - 28.0 * rpdot) * Dy + (-d[2010]) - 2115.0 * dv_794));
  ...
  sc_30 = (-d[370]) * dv_2136 +
          Dx * ((-d[2095]) * Dx +
                (-yp) * ((-d[2191]) * dv_751 + d[309] * dv_1803 + dv_2724 +
                         dv_2832) +
                (16.0 * d[20] * ypdot) * dv_2784);
  ...
  sc_33 = (-d[273]) * ((3556.0 * rpdot + 594.0) * dv_740 + 612.0 * dv_2293 -
  ...
  sc_33 += d[198] * (dv_3326 * dv_538 + ypddot * (dv_163 + dv_29));
  ...
  sc_31 += d[1105] * ((-d[1481]) * (dv_292 * xpddot + dv_3324) +
  ...
  sc_31 += dv_780 * ((27.0 - d[1353]) * dv_2489 +
                     ...
                     (12.0 * d[48] * yp) * (d[1418] + 609.0 * dv_1) +
                     (-112.0 * d[1135]));
  sc_30 = d[1951] * sc_31;
  ...
  sc_17 += -dv_0 * ((d[290] + 87.0 * d[3]) + dv_2590 + dv_3377) +
           xpddot * ((-d[2124]) * dv_45 + (4.0 * xpdot) * dv_3378);
  sc_18 = (-d[299]) * sc_17;
  ...
  sc_24 = (-d[319]) * (d[1247] * dv_3385 - dv_1762 * (29.0 * dv_1502 + 20.0) +
          ...
          (-d[544]) * (-dv_3140 + ypddot * (dv_2122 + dv_26));
  ...
  sc_24 += d[1619] * (dv_2663 + 6.0 * dv_2692) +
           d[436] * ((-ypdot) * dv_2680 + d[1193] * dv_644 + d[1344] * dv_617 +
                     dv_2717 - dv_3386);
  sc_29 = (-yp) * sc_24;
  ...
  sc_13 +=
      ...
      ((-d[2125]) * dv_2456 + (-d[631]) * (d[1401] + dv_2440 + 260.0 * dv_794) +
       (12.0 * d[48] * yp) * dv_3383 + d[50] * (d[1458] + dv_2589 - dv_3376));
  sc_17 = (-d[50]) * sc_13;
  ...
  sc_6 += d[27] * ((-d[1106]) * (dv_30 + dv_3381) + (M * ypddot) * dv_662 +
  ...
  sc_29 +=
      -Dx * (d[1] * (d[1578] * dv_1503 + d[1745] + dv_1683 - 77.0 * dv_2246) +
             d[261] *
                 ((-M) * (154.0 * dv_1503 + 9.0) + (77.0 * d[255]) + dv_2589) +
             d[416] * dv_1542) +
      sc_24;
  sc_13 = d[122] * sc_29;
  ...
  sc_16 = (-d[273]) * ((-d[7]) * (479.0 * dv_14 + 503.0 * dv_15 + dv_3401) +
          ...
          (-d[287]) * (dv_3391 + ypdot * (dv_396 + dv_629));
  ...
  sc_16 += (-d[50]) * ((-d[1242]) * dv_3394 + d[147] * dv_3389 -
                       ...
                       48.0 * dv_740) +
           (27.0 * d[57] * ypdot) * dv_3399 + (120.0 * d[151] * d[7]) * dv_635;
  sc_6 = d[1250] * sc_16;
  ...
  sc_28 += (4.0 * d[48] * yp * ypdot) * (d[88] + dv_2280);
  sc_16 = dv_2170 * sc_28;
  DataVector& dv_3392 = temps.at(2873);
  DataVector& dv_3393 = temps.at(2501);
  sc_24 = (-d[2126]) * ((-d[9]) * dv_3393 + yp * (dv_3392 + 163.0 * dv_833));
  ...
  sc_28 += d[1624] * ((-ypddot) * dv_463 + dv_2719) +
           d[631] * (d[1465] * dv_1 +
  ...
  sc_12 =
      (-d[1641]) * dv_1576 + (-d[751]) * (d[9] + dv_3045) +
      d[1411] * ((-M) * (172.0 * dv_1503 + 9.0) + (86.0 * d[255]) + dv_2775) +
      dv_2475;
  sc_12 += d[631] * ((45.0 * ypdot) * Dy - 430.0 * dv_2246 - dv_3377);
  sc_28 = -Dx * sc_12;
  DataVector& dv_3026 = temps.at(1766);
  DataVector& dv_3027 = temps.at(2486);
  sc_16 = d[1363] * dv_3388 +
          d[2126] * ((-yp) * (dv_3026 + 77.0 * dv_833) + dv_3027);
  ...
  sc_12 += d[77] * ((-ypdot) * (290.0 * dv_14 + 329.0 * dv_15 + dv_3390) +
                    58.0 * dv_833);
  sc_6 = (-d[6]) * sc_12;
  ...
  sc_28 +=
      ...
      ((-d[138]) * dv_3383 +
       ...
       (2.0 * M * yp) * (d[2133] - dv_1989 + 595.0 * dv_794) + (-d[1630]));
  ...
  sc_30 = d[1355] * dv_806 +
          d[2121] * ((-xpddot) * (dv_2123 + dv_29) + dv_2268) + sc_13 + sc_16 +
  ...
  sc_24 = (-d[1091]) * dv_3095 + (-d[1276]) * dv_3137 + (-d[1906]) * dv_45 +
          ...
          (-xpddot) * dv_2273 + d[142] * dv_541 + 32.0 * dv_3135 +
          8.0 * dv_3136 + dv_3139;
  ...
  sc_29 += (152.0 * d[1074]) * dv_14 + (342.0 * rpdot) * dv_3059 +
           (570.0 * d[1074]) * dv_46 + M * dv_3142 + d[1210] * dv_2286 +
  ...
  sc_29 += d[6] * (d[1839] * dv_578 + dv_2289) +
           dv_0 * ((-yp) * ((-d[1911] - 14.0) * dv_3140 + (400.0 * d[36]) +
                            475.0 * dv_3068) +
                   M * ((-d[1406]) + dv_2282 - dv_3141) + dv_2279);
  sc_24 = d[19] * sc_29;
  ...
  sc_13 +=
      d[1839] * ((-d[142]) * dv_587 + d[1915] * dv_45 + d[62] * dv_3144 +
                 dv_570 * xpdot) +
      yp * (dv_2298 * (d[1412] * dv_2295 + dv_2294 + dv_2297 * yp) + dv_2299);
  sc_29 = sc_13 * xp;
  ...
  sc_17 += (1064.0 * d[1792]) * dv_3147 + (1634.0 * d[1792]) * dv_3059 +
           (d[142] * d[248]) * dv_45 + (-d[1302] * rpdot) * dv_3007 +
           (285.0 * d[20] * rpdot) * dv_2868 +
           (456.0 * d[252] * rpdot) * dv_16 + d[1056] * dv_2326 +
  ...
  sc_17 +=
      d[6] *
      ((-d[20]) * ((d[1839] * ypdot) * dv_579 + dv_2337 + dv_3149 + dv_3150) +
       (-d[749]) * dv_547 + (M * yp) * ((114.0 * rpdot) * dv_580 + dv_2338) -
       dv_2333);
  ...
  sc_24 += dv_2170 * ((-M * yp * ypdot) * dv_2915 + d[20] * dv_2913 - dv_2916);
  sc_29 = (-d[52]) * sc_24;
  ...
  sc_12 += d[724] * ((-M) * (45.0 * dv_1503 + 11.0) +
  ...
  sc_16 = (-d[35]) * ((-d[20]) * ((-1360.0 * rpdot) * dv_739 + dv_2933) +
                      (-d[259]) * (d[1929] * dv_705 + dv_2934) + dv_2936) +
          dv_2943;
  DataVector& dv_2939 = temps.at(1273);
  sc_16 += d[1107] * (dv_2939 +
                      ypdot * ((d[1049] + 11.0) * dv_14 + (-d[1971]) * dv_15)) +
           sc_17;
  ...
  sc_6 +=
      d[259] *
      ((-d[7]) * ((48.0 * rpdot) * dv_707 + 190.0 * dv_15 - dv_420 - dv_629) +
  ...
  sc_6 *=
      Dx * ((d[1075] - d[1725] + 21.0) * dv_1190 +
            (-d[50]) * ((-d[36]) * (dv_3238 - 7.0) + d[2030] + dv_3140 +
                        dv_787 * rpdot) +
            d[273] * ((-M) * (dv_2551 + 2.0) + dv_2895 + dv_3239) + dv_2897) +
      dv_2894;
  ...
  sc_17 =
      d[286] * ((-d[50]) * ((-d[1076]) * dv_739 + dv_2901) +
                (16.0 * d[151]) * dv_15 +
                (M * d[20]) * (d[1049] * dv_543 + dv_2902) - dv_2898 - dv_777) +
      dv_2904 + sc_18 + sc_6;
  sc_16 = d[20] * sc_17;
  ...
  sc_6 += (d[334] * d[648]) * dv_1904 + (-d[1400] * d[6]) * dv_850 +
          ...
          (-d[354] * rpdot) * (d[2041] * dv_131 + d[2049] * dv_45 +
  ...
  sc_6 += (-d[104]) * dv_1063 * dv_1803 + (-d[138]) * dv_2379 * dv_5 +
          (-ypddot) * dv_112 * dv_2824 + d[271] * dv_1803 * dv_5 -
          33.0 * dv_1541 * dv_850;
}
}  // namespace CurvedScalarWave::Worldtube::detail
