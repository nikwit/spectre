...
// Event to synchronize device-resident evolved variables back to the host
// variables tag so standard observation events can run unchanged.
...
class SyncKokkosToHost : public Event {
 public:
  ...
  static constexpr Options::String help = {
      "Synchronize Kokkos device evolved variables to host memory for "
      "observation."};
  ...
  using argument_tags =
      tmpl::list<ScalarWave::KokkosTags::DeviceVariables<System>>;
  ...
  void operator()(
      ...
      const typename ScalarWave::KokkosTags::DeviceVariables<System>::type&
          device_vars,
