...
class SyncKokkosToHost : public Event {
 public:
  ...
  using argument_tags = tmpl::list<DeviceVariablesTag>;
  ...
  void operator()(
      ...
      const typename DeviceVariablesTag::type& device_vars,
...
template <typename System, typename DeviceVariablesTag>
PUP::able::PUP_ID SyncKokkosToHost<System, DeviceVariablesTag>::my_PUP_ID =
    0;  // NOLINT
